    ...
    public partial class wx : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var model = new BLL.weixin_account().GetModel(uid);
                ...
                var postModel = new PostModel()
                {
                    ...
                    Token = token,
                    EncodingAESKey = model.appsecret,// "mNnY5GekpChwqhy2c4NBH90g3hND6GeI4gii2YCvKLY",//根据自己后台的设置保持一致
                    AppId = model.appid// "wx669ef95216eef885"//根据自己后台的设置保持一致
                };
