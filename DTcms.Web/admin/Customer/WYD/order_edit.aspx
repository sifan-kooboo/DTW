<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_edit.aspx.cs" Inherits="DTcms.Web.admin.Customer.WYD.order_edit" %>
...
<script type="text/javascript">
    ...
    function OrderPrint() {
        var winDialog = top.dialog({
            title: '打印订单',
            url: '../admin/dialog/dialog_print.aspx?order_no=' + $("#spanOrderNo").text(),
            width: 850
        }).showModal();
    }
    //修改收货信息
...
<!--导航栏-->
<div class="location">
  <a href="express_list.aspx" class="back"><i></i><span>返回列表页(这也要改)</span></a>
