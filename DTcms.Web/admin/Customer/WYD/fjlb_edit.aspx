<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="fjlb_edit.aspx.cs" Inherits="DTcms.Web.admin.Customer.WYD.fjlb_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="fjlb_list.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="fjlb_list.aspx?channel_id=<%=this.channel_id %>"><span>内容类别</span></a>
  <i class="arrow"></i>
  <span>编辑分类</span>
</div>
