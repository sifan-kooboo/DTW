...
namespace Hotel_app.DAL
{
	...
	public partial class Ffjrb
	{
		...
		public int Add(Hotel_app.Model.Ffjrb model)
		{
			...
			strSql.Append("yydh,qymc,fjrb_code,fjrb,sjjg,zyrs,is_top,is_select)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@zyrs", SqlDbType.Decimal,9),
		...
		public Hotel_app.Model.Ffjrb GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,fjrb_code,fjrb,sjjg,zyrs,is_top,is_select from Ffjrb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Ffjrb model=new Hotel_app.Model.Ffjrb();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,fjrb_code,fjrb,sjjg,zyrs,is_top,is_select ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,fjrb_code,fjrb,sjjg,zyrs,is_top,is_select ");
			strSql.Append(" FROM Ffjrb ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
