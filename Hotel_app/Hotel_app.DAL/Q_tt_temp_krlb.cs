...
namespace Hotel_app.DAL
{
	...
	public partial class Q_tt_temp_krlb
	{
		...
		public int Add(Hotel_app.Model.Q_tt_temp_krlb model)
		{
			...
			strSql.Append("insert into Q_tt_temp_krlb(");
			strSql.Append("yydh,qymc,ddbh,lsbh,krxm,krly,ddsj,lksj,fjrb,fjbh,lzfs,sjfjjg,xsy,czy_temp,sktt)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@krly", SqlDbType.VarChar,100),
					...
					new SqlParameter("@lzfs", SqlDbType.VarChar,50),
					new SqlParameter("@sjfjjg", SqlDbType.VarChar,50),
			...
			parameters[13].Value = model.czy_temp;
			parameters[14].Value = model.sktt;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Q_tt_temp_krlb set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Q_tt_temp_krlb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Q_tt_temp_krlb GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,ddbh,lsbh,krxm,krly,ddsj,lksj,fjrb,fjbh,lzfs,sjfjjg,xsy,czy_temp,sktt from Q_tt_temp_krlb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Q_tt_temp_krlb model=new Hotel_app.Model.Q_tt_temp_krlb();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				{
					model.lzfs=ds.Tables[0].Rows[0]["lzfs"].ToString();
				}
				if(ds.Tables[0].Rows[0]["sjfjjg"]!=null && ds.Tables[0].Rows[0]["sjfjjg"].ToString()!="")
				{
					model.sjfjjg=ds.Tables[0].Rows[0]["sjfjjg"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,ddbh,lsbh,krxm,krly,ddsj,lksj,fjrb,fjbh,lzfs,sjfjjg,xsy,czy_temp,sktt ");
			strSql.Append(" FROM Q_tt_temp_krlb ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,ddbh,lsbh,krxm,krly,ddsj,lksj,fjrb,fjbh,lzfs,sjfjjg,xsy,czy_temp,sktt ");
			strSql.Append(" FROM Q_tt_temp_krlb ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Q_tt_temp_krlb ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Q_tt_temp_krlb T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Q_tt_temp_krlb";
