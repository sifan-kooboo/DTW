...
namespace Hotel_app.DAL
{
	...
	public partial class Xkrgj
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xkrgj"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xkrgj");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Xkrgj(");
			strSql.Append("yydh,qymc,krgj,zjm,pq,is_top,is_select)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Xkrgj set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Xkrgj ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Xkrgj GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,krgj,zjm,pq,is_top,is_select from Xkrgj ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Xkrgj model=new Hotel_app.Model.Xkrgj();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,krgj,zjm,pq,is_top,is_select ");
			strSql.Append(" FROM Xkrgj ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,krgj,zjm,pq,is_top,is_select ");
			strSql.Append(" FROM Xkrgj ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xkrgj T ");
