...
namespace Hotel_app.DAL
{
	...
	public partial class Szw_temp
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Szw_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Szw_temp");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Szw_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Szw_temp(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Szw_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Szw_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Szw_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Szw_temp GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,fkfs,jjje,xfje,yh,sjxfje,xfsl,shsc,mxbh,czsj,czy_temp from Szw_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Szw_temp model=new Hotel_app.Model.Szw_temp();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Szw_temp T ");
