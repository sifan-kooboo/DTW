...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:VIEW_Qttyd_qx
	/// </summary>
	public partial class VIEW_Qttyd_qx
	{
		public VIEW_Qttyd_qx()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.VIEW_Qttyd_qx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_Qttyd_qx(");
			strSql.Append("yydh,lsbh,qymc,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,qxyy,ddly)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_Qttyd_qx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_Qttyd_qx set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_Qttyd_qx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_Qttyd_qx GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,lsbh,qymc,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,qxyy,ddly from VIEW_Qttyd_qx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.VIEW_Qttyd_qx model=new Hotel_app.Model.VIEW_Qttyd_qx();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,lsbh,qymc,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,qxyy,ddly ");
			strSql.Append(" FROM VIEW_Qttyd_qx ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,lsbh,qymc,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,qxyy,ddly ");
			strSql.Append(" FROM VIEW_Qttyd_qx ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_Qttyd_qx ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_Qttyd_qx T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_Qttyd_qx";
