...
namespace Hotel_app.DAL
{
	...
	public partial class Szwzd
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Szwzd"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Szwzd");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Szwzd model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Szwzd(");
			strSql.Append("yydh,qymc,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,main_sec,is_top,is_select,is_ffzf)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@is_ffzf", SqlDbType.Bit,1)};
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Szwzd model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Szwzd set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Szwzd ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Szwzd GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,main_sec,is_top,is_select,is_ffzf from Szwzd ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Szwzd model=new Hotel_app.Model.Szwzd();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["is_ffzf"]!=null && ds.Tables[0].Rows[0]["is_ffzf"].ToString()!="")
				{
					if((ds.Tables[0].Rows[0]["is_ffzf"].ToString()=="1")||(ds.Tables[0].Rows[0]["is_ffzf"].ToString().ToLower()=="true"))
					{
						model.is_ffzf=true;
					}
					else
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,main_sec,is_top,is_select,is_ffzf ");
			strSql.Append(" FROM Szwzd ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,main_sec,is_top,is_select,is_ffzf ");
			strSql.Append(" FROM Szwzd ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Szwzd T ");
