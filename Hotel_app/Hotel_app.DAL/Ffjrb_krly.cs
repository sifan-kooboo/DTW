...
namespace Hotel_app.DAL
{
	...
	public partial class Ffjrb_krly
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Ffjrb_krly"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Ffjrb_krly");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Ffjrb_krly model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ffjrb_krly(");
			strSql.Append("yydh,qymc,krly,fjrb,fjrb_code,sjjg,is_top,is_select)");
			...
			parameters[4].Value = model.fjrb_code;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Ffjrb_krly model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ffjrb_krly set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ffjrb_krly ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Ffjrb_krly GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,krly,fjrb,fjrb_code,sjjg,is_top,is_select from Ffjrb_krly ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Ffjrb_krly model=new Hotel_app.Model.Ffjrb_krly();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,krly,fjrb,fjrb_code,sjjg,is_top,is_select ");
			strSql.Append(" FROM Ffjrb_krly ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,krly,fjrb,fjrb_code,sjjg,is_top,is_select ");
			strSql.Append(" FROM Ffjrb_krly ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Ffjrb_krly T ");
