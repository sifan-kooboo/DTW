...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:BBfx_jzmx_bak
	/// </summary>
	public partial class BBfx_jzmx_bak
	{
		public BBfx_jzmx_bak()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.BBfx_jzmx_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BBfx_jzmx_bak(");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@mxbh", SqlDbType.VarChar,200),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.BBfx_jzmx_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BBfx_jzmx_bak set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BBfx_jzmx_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.BBfx_jzmx_bak GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh,czy_temp from BBfx_jzmx_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.BBfx_jzmx_bak model=new Hotel_app.Model.BBfx_jzmx_bak();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BBfx_jzmx_bak ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM BBfx_jzmx_bak ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BBfx_jzmx_bak T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BBfx_jzmx_bak";
