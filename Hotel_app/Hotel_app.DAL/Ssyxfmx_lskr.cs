...
namespace Hotel_app.DAL
{
	...
	public partial class Ssyxfmx_lskr
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Ssyxfmx_lskr"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Ssyxfmx_lskr");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Ssyxfmx_lskr model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ssyxfmx_lskr(");
			strSql.Append("yydh,qymc,krxm,zjhm,id_app,shsc)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Ssyxfmx_lskr model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ssyxfmx_lskr set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ssyxfmx_lskr ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Ssyxfmx_lskr GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,krxm,zjhm,id_app,shsc from Ssyxfmx_lskr ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Ssyxfmx_lskr model=new Hotel_app.Model.Ssyxfmx_lskr();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,krxm,zjhm,id_app,shsc ");
			strSql.Append(" FROM Ssyxfmx_lskr ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,krxm,zjhm,id_app,shsc ");
			strSql.Append(" FROM Ssyxfmx_lskr ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Ssyxfmx_lskr T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Ssyxfmx_lskr";
