...
namespace Hotel_app.DAL
{
	...
	public partial class Xsfzcs
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xsfzcs"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xsfzcs");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Xsfzcs ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,sfdm,sfmc,csdm,csmc ");
			strSql.Append(" FROM Xsfzcs ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,sfdm,sfmc,csdm,csmc ");
			strSql.Append(" FROM Xsfzcs ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xsfzcs T ");
