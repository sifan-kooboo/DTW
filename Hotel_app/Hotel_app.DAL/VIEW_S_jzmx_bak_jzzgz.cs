...
{
	/// <summary>
	/// 数据访问类:VIEW_S_jzmx_bak_jzzgz
	/// </summary>
	public partial class VIEW_S_jzmx_bak_jzzgz
	{
		public VIEW_S_jzmx_bak_jzzgz()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_S_jzmx_bak_jzzgz(");
			strSql.Append("yydh,qymc,is_top,is_select,id_app,jzbh,jzbh_new,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh)");
			...
			parameters[6].Value = model.jzbh_new;
			...
			parameters[20].Value = model.jjje;
			parameters[21].Value = model.xfje;
			parameters[22].Value = model.yh;
			parameters[23].Value = model.sjxfje;
			parameters[24].Value = model.xfsl;
			parameters[25].Value = model.shsc;
			parameters[26].Value = model.czy_bc;
			parameters[27].Value = model.czzt;
			parameters[28].Value = model.tfsj;
			parameters[29].Value = model.czsj;
			parameters[30].Value = model.syzd;
			parameters[31].Value = model.is_visible;
			parameters[32].Value = model.xyh;
			parameters[33].Value = model.jzzt;
			parameters[34].Value = model.fkfs;
			parameters[35].Value = model.mxbh;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_S_jzmx_bak_jzzgz set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_S_jzmx_bak_jzzgz ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,jzbh_new,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh from VIEW_S_jzmx_bak_jzzgz ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz model=new Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_top,is_select,id_app,jzbh,jzbh_new,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh ");
			strSql.Append(" FROM VIEW_S_jzmx_bak_jzzgz ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,is_top,is_select,id_app,jzbh,jzbh_new,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh ");
			strSql.Append(" FROM VIEW_S_jzmx_bak_jzzgz ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_S_jzmx_bak_jzzgz ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_S_jzmx_bak_jzzgz T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_S_jzmx_bak_jzzgz";
