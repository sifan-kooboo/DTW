...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:VIEW_S_xf_ds
	/// </summary>
	public partial class VIEW_S_xf_ds
	{
		public VIEW_S_xf_ds()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.VIEW_S_xf_ds model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_S_xf_ds(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_S_xf_ds model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_S_xf_ds set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_S_xf_ds ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_S_xf_ds GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,ddsj,lksj,czsj from VIEW_S_xf_ds ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.VIEW_S_xf_ds model=new Hotel_app.Model.VIEW_S_xf_ds();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM VIEW_S_xf_ds ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_S_xf_ds ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_S_xf_ds T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_S_xf_ds";
