...
{
	/// <summary>
	/// 数据访问类:VIEW_Qttyd_djb
	/// </summary>
	public partial class VIEW_Qttyd_djb
	{
		public VIEW_Qttyd_djb()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.VIEW_Qttyd_djb model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_Qttyd_djb(");
			strSql.Append("yydh,qymc,lsbh,krxm,krmz,krjg,ddly,fjbh,krxb,ddbh,yxzj,zjhm,krsj,xydw,xyh,ddsj,lksj,krsr,krzy,krdz,sjfjjg,yddj)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_Qttyd_djb model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_Qttyd_djb set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_Qttyd_djb ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_Qttyd_djb GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 yydh,qymc,lsbh,krxm,krmz,krjg,ddly,fjbh,krxb,ddbh,yxzj,zjhm,krsj,xydw,xyh,ddsj,lksj,krsr,krzy,krdz,sjfjjg,yddj from VIEW_Qttyd_djb ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.VIEW_Qttyd_djb model=new Hotel_app.Model.VIEW_Qttyd_djb();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select yydh,qymc,lsbh,krxm,krmz,krjg,ddly,fjbh,krxb,ddbh,yxzj,zjhm,krsj,xydw,xyh,ddsj,lksj,krsr,krzy,krdz,sjfjjg,yddj ");
			strSql.Append(" FROM VIEW_Qttyd_djb ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_Qttyd_djb ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_Qttyd_djb T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_Qttyd_djb";
