...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:BS_jzmx_ls
	/// </summary>
	public partial class BS_jzmx_ls
	{
		public BS_jzmx_ls()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.BS_jzmx_ls model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BS_jzmx_ls(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.BS_jzmx_ls model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BS_jzmx_ls set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BS_jzmx_ls ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.BS_jzmx_ls GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh,czy_temp from BS_jzmx_ls ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.BS_jzmx_ls model=new Hotel_app.Model.BS_jzmx_ls();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM BS_jzmx_ls ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BS_jzmx_ls T ");
