...
namespace Hotel_app.DAL
{
	...
	public partial class Ssyxfmx_kc
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Ssyxfmx_kc"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Ssyxfmx_kc");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ssyxfmx_kc(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ssyxfmx_kc set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ssyxfmx_kc ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Ssyxfmx_kc GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,lsbh_jk,czsj_jk,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,shbd from Ssyxfmx_kc ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Ssyxfmx_kc model=new Hotel_app.Model.Ssyxfmx_kc();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Ssyxfmx_kc T ");
