...
{
	/// <summary>
	/// 数据访问类:Qskyd_mainrecord_temp
	/// </summary>
	public partial class Qskyd_mainrecord_temp
	{
		public Qskyd_mainrecord_temp()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qskyd_mainrecord_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qskyd_mainrecord_temp");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Qskyd_mainrecord_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Qskyd_mainrecord_temp(");
			strSql.Append("yydh,qymc,lsbh,ddbh,is_top,is_select,hykh,hyrx,krxm,tlkr,krgj,krmz,yxzj,zjhm,krxb,krsr,krdh,krsj,krEmail,krdz,krjg,krdw,krzy,cxmd,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,krly,xyh,xydw,xsy,ddrx,ddwz,zyzt,krrx,kr_children,ddsj,ddyy,lzts,lksj,qtyq,czy,czsj,cznr,shsc,sktt,yddj,ffshys,ffzf,main_sec,sdcz,syzd,vip_type,tsyq,qxyy,ddly,hykh_bz)");
			...
			parameters[40].Value = model.ddyy;
			...
			parameters[57].Value = model.qxyy;
			parameters[58].Value = model.ddly;
			parameters[59].Value = model.hykh_bz;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Qskyd_mainrecord_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Qskyd_mainrecord_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qskyd_mainrecord_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Qskyd_mainrecord_temp GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lsbh,ddbh,is_top,is_select,hykh,hyrx,krxm,tlkr,krgj,krmz,yxzj,zjhm,krxb,krsr,krdh,krsj,krEmail,krdz,krjg,krdw,krzy,cxmd,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,krly,xyh,xydw,xsy,ddrx,ddwz,zyzt,krrx,kr_children,ddsj,ddyy,lzts,lksj,qtyq,czy,czsj,cznr,shsc,sktt,yddj,ffshys,ffzf,main_sec,sdcz,syzd,vip_type,tsyq,qxyy,ddly,hykh_bz from Qskyd_mainrecord_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Qskyd_mainrecord_temp model=new Hotel_app.Model.Qskyd_mainrecord_temp();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Qskyd_mainrecord_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qskyd_mainrecord_temp T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Qskyd_mainrecord_temp";
