...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:View_Hhygl
	/// </summary>
	public partial class View_Hhygl
	{
		public View_Hhygl()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.View_Hhygl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into View_Hhygl(");
			strSql.Append("yydh,qymc,hyrx,hykh,hykh_bz,krxm,krgj,krmz,yxzj,zjhm,krsr,krxb,krdh,krsj,krEmail,krdz,krzy,krdw,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,bz,djsj,hyjf,dfjf,shsc,scsj,xgsj,shxg,shqr,is_top,is_select,fkje,parent_hykh,hymm,xsy,czy)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@hymm", SqlDbType.VarChar,100),
			...
			parameters[27].Value = model.dfjf;
			parameters[28].Value = model.shsc;
			parameters[29].Value = model.scsj;
			parameters[30].Value = model.xgsj;
			parameters[31].Value = model.shxg;
			parameters[32].Value = model.shqr;
			parameters[33].Value = model.is_top;
			parameters[34].Value = model.is_select;
			parameters[35].Value = model.fkje;
			parameters[36].Value = model.parent_hykh;
			parameters[37].Value = model.hymm;
			parameters[38].Value = model.xsy;
			parameters[39].Value = model.czy;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.View_Hhygl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update View_Hhygl set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from View_Hhygl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.View_Hhygl GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,hyrx,hykh,hykh_bz,krxm,krgj,krmz,yxzj,zjhm,krsr,krxb,krdh,krsj,krEmail,krdz,krzy,krdw,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,bz,djsj,hyjf,dfjf,shsc,scsj,xgsj,shxg,shqr,is_top,is_select,fkje,parent_hykh,hymm,xsy,czy from View_Hhygl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.View_Hhygl model=new Hotel_app.Model.View_Hhygl();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["hymm"]!=null && ds.Tables[0].Rows[0]["hymm"].ToString()!="")
				{
					model.hymm=ds.Tables[0].Rows[0]["hymm"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,hyrx,hykh,hykh_bz,krxm,krgj,krmz,yxzj,zjhm,krsr,krxb,krdh,krsj,krEmail,krdz,krzy,krdw,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,bz,djsj,hyjf,dfjf,shsc,scsj,xgsj,shxg,shqr,is_top,is_select,fkje,parent_hykh,hymm,xsy,czy ");
			strSql.Append(" FROM View_Hhygl ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,hyrx,hykh,hykh_bz,krxm,krgj,krmz,yxzj,zjhm,krsr,krxb,krdh,krsj,krEmail,krdz,krzy,krdw,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,bz,djsj,hyjf,dfjf,shsc,scsj,xgsj,shxg,shqr,is_top,is_select,fkje,parent_hykh,hymm,xsy,czy ");
			strSql.Append(" FROM View_Hhygl ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM View_Hhygl ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from View_Hhygl T ");
