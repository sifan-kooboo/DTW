...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:VIEW_S_KC
	/// </summary>
	public partial class VIEW_S_KC
	{
		public VIEW_S_KC()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.VIEW_S_KC model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_S_KC(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_S_KC model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_S_KC set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_S_KC ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_S_KC GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfsj,xfrq,czy,xfdr,xfrb,xfxm,xfbz,jjje,xfzy,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,ddsj,lksj,czsj,id,xftm from VIEW_S_KC ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.VIEW_S_KC model=new Hotel_app.Model.VIEW_S_KC();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_S_KC ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_S_KC T ");
