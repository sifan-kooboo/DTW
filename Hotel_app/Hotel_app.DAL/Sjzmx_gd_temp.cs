...
namespace Hotel_app.DAL
{
	...
	public partial class Sjzmx_gd_temp
	{
		...
		public int Add(Hotel_app.Model.Sjzmx_gd_temp model)
		{
			...
			strSql.Append("insert into Sjzmx_gd_temp(");
			strSql.Append("yydh,qymc,is_top,is_select,id_app,jzbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfrb,xfdr,xfxm,xfbz,xfzy,jjje,yh,xfje,sjxfje,xfsl,shsc,czzt,czy_bc,tfsj,czsj,is_visible,syzd,xyh,jzzt,fkfs,mxbh,zd_fkje,zd_xfje,zd_ddsj,zd_tfsj,zd_fjbh,zd_krxm_lz,zd_fjbh_lz,czy_temp,lsbh)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@fjrb", SqlDbType.VarChar,200),
					new SqlParameter("@fjbh", SqlDbType.VarChar,200),
					...
					new SqlParameter("@xfbz", SqlDbType.VarChar,300),
					new SqlParameter("@xfzy", SqlDbType.VarChar,300),
					...
					new SqlParameter("@fkfs", SqlDbType.VarChar,200),
					new SqlParameter("@mxbh", SqlDbType.VarChar,50),
					new SqlParameter("@zd_fkje", SqlDbType.Float,8),
					new SqlParameter("@zd_xfje", SqlDbType.Float,8),
					new SqlParameter("@zd_ddsj", SqlDbType.DateTime),
					new SqlParameter("@zd_tfsj", SqlDbType.DateTime),
					new SqlParameter("@zd_fjbh", SqlDbType.VarChar,50),
					new SqlParameter("@zd_krxm_lz", SqlDbType.VarChar,200),
					new SqlParameter("@zd_fjbh_lz", SqlDbType.VarChar,200),
			...
			parameters[18].Value = model.jjje;
			parameters[19].Value = model.yh;
			parameters[20].Value = model.xfje;
			parameters[21].Value = model.sjxfje;
			parameters[22].Value = model.xfsl;
			parameters[23].Value = model.shsc;
			parameters[24].Value = model.czzt;
			parameters[25].Value = model.czy_bc;
			parameters[26].Value = model.tfsj;
			parameters[27].Value = model.czsj;
			parameters[28].Value = model.is_visible;
			parameters[29].Value = model.syzd;
			parameters[30].Value = model.xyh;
			parameters[31].Value = model.jzzt;
			parameters[32].Value = model.fkfs;
			parameters[33].Value = model.mxbh;
			parameters[34].Value = model.zd_fkje;
			parameters[35].Value = model.zd_xfje;
			parameters[36].Value = model.zd_ddsj;
			parameters[37].Value = model.zd_tfsj;
			parameters[38].Value = model.zd_fjbh;
			parameters[39].Value = model.zd_krxm_lz;
			parameters[40].Value = model.zd_fjbh_lz;
			parameters[41].Value = model.czy_temp;
			parameters[42].Value = model.lsbh;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sjzmx_gd_temp set ");
			...
			strSql.Append("zd_fkje=@zd_fkje,");
			strSql.Append("zd_xfje=@zd_xfje,");
			strSql.Append("zd_ddsj=@zd_ddsj,");
			strSql.Append("zd_tfsj=@zd_tfsj,");
			strSql.Append("zd_fjbh=@zd_fjbh,");
			strSql.Append("zd_krxm_lz=@zd_krxm_lz,");
			strSql.Append("zd_fjbh_lz=@zd_fjbh_lz,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sjzmx_gd_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Sjzmx_gd_temp GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfrb,xfdr,xfxm,xfbz,xfzy,jjje,yh,xfje,sjxfje,xfsl,shsc,czzt,czy_bc,tfsj,czsj,is_visible,syzd,xyh,jzzt,fkfs,mxbh,zd_fkje,zd_xfje,zd_ddsj,zd_tfsj,zd_fjbh,zd_krxm_lz,zd_fjbh_lz,czy_temp,lsbh from Sjzmx_gd_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Sjzmx_gd_temp model=new Hotel_app.Model.Sjzmx_gd_temp();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["zd_fkje"]!=null && ds.Tables[0].Rows[0]["zd_fkje"].ToString()!="")
				{
					model.zd_fkje=decimal.Parse(ds.Tables[0].Rows[0]["zd_fkje"].ToString());
				}
				if(ds.Tables[0].Rows[0]["zd_xfje"]!=null && ds.Tables[0].Rows[0]["zd_xfje"].ToString()!="")
				{
					model.zd_xfje=decimal.Parse(ds.Tables[0].Rows[0]["zd_xfje"].ToString());
				}
				if(ds.Tables[0].Rows[0]["zd_ddsj"]!=null && ds.Tables[0].Rows[0]["zd_ddsj"].ToString()!="")
				{
					model.zd_ddsj=DateTime.Parse(ds.Tables[0].Rows[0]["zd_ddsj"].ToString());
				}
				if(ds.Tables[0].Rows[0]["zd_tfsj"]!=null && ds.Tables[0].Rows[0]["zd_tfsj"].ToString()!="")
				{
					model.zd_tfsj=DateTime.Parse(ds.Tables[0].Rows[0]["zd_tfsj"].ToString());
				}
				if(ds.Tables[0].Rows[0]["zd_fjbh"]!=null && ds.Tables[0].Rows[0]["zd_fjbh"].ToString()!="")
				{
					model.zd_fjbh=ds.Tables[0].Rows[0]["zd_fjbh"].ToString();
				}
				if(ds.Tables[0].Rows[0]["zd_krxm_lz"]!=null && ds.Tables[0].Rows[0]["zd_krxm_lz"].ToString()!="")
				{
					model.zd_krxm_lz=ds.Tables[0].Rows[0]["zd_krxm_lz"].ToString();
				}
				if(ds.Tables[0].Rows[0]["zd_fjbh_lz"]!=null && ds.Tables[0].Rows[0]["zd_fjbh_lz"].ToString()!="")
				{
					model.zd_fjbh_lz=ds.Tables[0].Rows[0]["zd_fjbh_lz"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_top,is_select,id_app,jzbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfrb,xfdr,xfxm,xfbz,xfzy,jjje,yh,xfje,sjxfje,xfsl,shsc,czzt,czy_bc,tfsj,czsj,is_visible,syzd,xyh,jzzt,fkfs,mxbh,zd_fkje,zd_xfje,zd_ddsj,zd_tfsj,zd_fjbh,zd_krxm_lz,zd_fjbh_lz,czy_temp,lsbh ");
			strSql.Append(" FROM Sjzmx_gd_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,is_top,is_select,id_app,jzbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfrb,xfdr,xfxm,xfbz,xfzy,jjje,yh,xfje,sjxfje,xfsl,shsc,czzt,czy_bc,tfsj,czsj,is_visible,syzd,xyh,jzzt,fkfs,mxbh,zd_fkje,zd_xfje,zd_ddsj,zd_tfsj,zd_fjbh,zd_krxm_lz,zd_fjbh_lz,czy_temp,lsbh ");
			strSql.Append(" FROM Sjzmx_gd_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Sjzmx_gd_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Sjzmx_gd_temp T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Sjzmx_gd_temp";
