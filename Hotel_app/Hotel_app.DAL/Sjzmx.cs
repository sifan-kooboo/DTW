...
namespace Hotel_app.DAL
{
	...
	public partial class Sjzmx
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Sjzmx"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Sjzmx");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Sjzmx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Sjzmx(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Sjzmx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sjzmx set ");
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Sjzmx GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh from Sjzmx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Sjzmx model=new Hotel_app.Model.Sjzmx();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Sjzmx T ");
