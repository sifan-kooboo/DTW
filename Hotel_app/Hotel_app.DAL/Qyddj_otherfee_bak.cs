...
{
	/// <summary>
	/// 数据访问类:Qyddj_otherfee_bak
	/// </summary>
	public partial class Qyddj_otherfee_bak
	{
		public Qyddj_otherfee_bak()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qyddj_otherfee_bak"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qyddj_otherfee_bak");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Qyddj_otherfee_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Qyddj_otherfee_bak(");
			strSql.Append("yydh,qymc,is_select,is_top,jzbh,lsbh,krxm,sktt,fjbh,fyrx,xfdr,xfrb,xfxm,xfsl,jjje,xfje,shsc,czy,cznr,czsj,sdcz,mxbh)");
			...
			parameters[17].Value = model.czy;
			parameters[18].Value = model.cznr;
			parameters[19].Value = model.czsj;
			parameters[20].Value = model.sdcz;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Qyddj_otherfee_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Qyddj_otherfee_bak set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qyddj_otherfee_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Qyddj_otherfee_bak GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_select,is_top,jzbh,lsbh,krxm,sktt,fjbh,fyrx,xfdr,xfrb,xfxm,xfsl,jjje,xfje,shsc,czy,cznr,czsj,sdcz,mxbh from Qyddj_otherfee_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Qyddj_otherfee_bak model=new Hotel_app.Model.Qyddj_otherfee_bak();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_select,is_top,jzbh,lsbh,krxm,sktt,fjbh,fyrx,xfdr,xfrb,xfxm,xfsl,jjje,xfje,shsc,czy,cznr,czsj,sdcz,mxbh ");
			strSql.Append(" FROM Qyddj_otherfee_bak ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,is_select,is_top,jzbh,lsbh,krxm,sktt,fjbh,fyrx,xfdr,xfrb,xfxm,xfsl,jjje,xfje,shsc,czy,cznr,czsj,sdcz,mxbh ");
			strSql.Append(" FROM Qyddj_otherfee_bak ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qyddj_otherfee_bak T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Qyddj_otherfee_bak";
