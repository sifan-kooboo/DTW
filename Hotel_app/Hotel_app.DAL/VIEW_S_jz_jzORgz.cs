...
{
	/// <summary>
	/// 数据访问类:VIEW_S_jz_jzORgz
	/// </summary>
	public partial class VIEW_S_jz_jzORgz
	{
		public VIEW_S_jz_jzORgz()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.VIEW_S_jz_jzORgz model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_S_jz_jzORgz(");
			strSql.Append("id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,syzd,is_visible,xyh,fkfs,mxbh,ddsj,jzzt,czzt,lksj,tfsj,krly,xydw,czsj)");
			...
			parameters[27].Value = model.syzd;
			parameters[28].Value = model.is_visible;
			parameters[29].Value = model.xyh;
			parameters[30].Value = model.fkfs;
			parameters[31].Value = model.mxbh;
			parameters[32].Value = model.ddsj;
			parameters[33].Value = model.jzzt;
			parameters[34].Value = model.czzt;
			parameters[35].Value = model.lksj;
			parameters[36].Value = model.tfsj;
			parameters[37].Value = model.krly;
			parameters[38].Value = model.xydw;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_S_jz_jzORgz model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_S_jz_jzORgz set ");
			strSql.Append("id=@id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_S_jz_jzORgz ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_S_jz_jzORgz GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,syzd,is_visible,xyh,fkfs,mxbh,ddsj,jzzt,czzt,lksj,tfsj,krly,xydw,czsj from VIEW_S_jz_jzORgz ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.VIEW_S_jz_jzORgz model=new Hotel_app.Model.VIEW_S_jz_jzORgz();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,syzd,is_visible,xyh,fkfs,mxbh,ddsj,jzzt,czzt,lksj,tfsj,krly,xydw,czsj ");
			strSql.Append(" FROM VIEW_S_jz_jzORgz ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_S_jz_jzORgz ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_S_jz_jzORgz T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_S_jz_jzORgz";
