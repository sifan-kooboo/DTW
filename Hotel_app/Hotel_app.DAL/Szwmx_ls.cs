...
namespace Hotel_app.DAL
{
	...
	public partial class Szwmx_ls
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.Szwmx_ls model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Szwmx_ls(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Szwmx_ls model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Szwmx_ls set ");
			strSql.Append("id=@id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Szwmx_ls ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Szwmx_ls GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh from Szwmx_ls ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.Szwmx_ls model=new Hotel_app.Model.Szwmx_ls();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM Szwmx_ls ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Szwmx_ls T ");
