...
namespace Hotel_app.DAL
{
	...
	public partial class Q_sfz_temp
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Q_sfz_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Q_sfz_temp");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Q_sfz_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,zjhm,krxm,krmz,krxb,krsr,krdz,department,startdate,enddate,krxp,shcl,czsj,fjbh ");
			strSql.Append(" FROM Q_sfz_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,zjhm,krxm,krmz,krxb,krsr,krdz,department,startdate,enddate,krxp,shcl,czsj,fjbh ");
			strSql.Append(" FROM Q_sfz_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Q_sfz_temp T ");
