...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:Sjzmx_bak
	/// </summary>
	public partial class Sjzmx_bak
	{
		public Sjzmx_bak()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Sjzmx_bak"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Sjzmx_bak");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Sjzmx_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Sjzmx_bak(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Sjzmx_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sjzmx_bak set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sjzmx_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Sjzmx_bak GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,jzbh_new,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh from Sjzmx_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Sjzmx_bak model=new Hotel_app.Model.Sjzmx_bak();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Sjzmx_bak T ");
