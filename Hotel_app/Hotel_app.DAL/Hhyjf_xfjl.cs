...
namespace Hotel_app.DAL
{
	...
	public partial class Hhyjf_xfjl
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Hhyjf_xfjl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Hhyjf_xfjl(");
			strSql.Append("qymc,yydh,lsbh_df,hykh,hykh_bz,krxm,id_app,lsbh,fjrb,fjbh,xfrq,xfsj,hyjf,bz,xfdr,xfrb,xfxm,sjxfje,shsc,scsj,is_top,is_select,shqx,parent_hykh,czy)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Hhyjf_xfjl model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Hhyjf_xfjl GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,qymc,yydh,lsbh_df,hykh,hykh_bz,krxm,id_app,lsbh,fjrb,fjbh,xfrq,xfsj,hyjf,bz,xfdr,xfrb,xfxm,sjxfje,shsc,scsj,is_top,is_select,shqx,parent_hykh,czy from Hhyjf_xfjl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Hhyjf_xfjl model=new Hotel_app.Model.Hhyjf_xfjl();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,qymc,yydh,lsbh_df,hykh,hykh_bz,krxm,id_app,lsbh,fjrb,fjbh,xfrq,xfsj,hyjf,bz,xfdr,xfrb,xfxm,sjxfje,shsc,scsj,is_top,is_select,shqx,parent_hykh,czy ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,qymc,yydh,lsbh_df,hykh,hykh_bz,krxm,id_app,lsbh,fjrb,fjbh,xfrq,xfsj,hyjf,bz,xfdr,xfrb,xfxm,sjxfje,shsc,scsj,is_top,is_select,shqx,parent_hykh,czy ");
			strSql.Append(" FROM Hhyjf_xfjl ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
