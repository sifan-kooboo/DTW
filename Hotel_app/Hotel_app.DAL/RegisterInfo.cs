...
namespace Hotel_app.DAL
{
	...
	public partial class RegisterInfo
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "RegisterInfo"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from RegisterInfo");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into RegisterInfo(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update RegisterInfo set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from RegisterInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.RegisterInfo GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,DiskID,CpuID,MachineID,RegisterTime,Email,UserName,UserGuid,mobile,RegisterYears,xxzs,RegisterKey,StartUseTime,EndUseTime,UseTimes,lastLoginTime,RegisterKey_temp from RegisterInfo ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.RegisterInfo model=new Hotel_app.Model.RegisterInfo();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM RegisterInfo ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from RegisterInfo T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "RegisterInfo";
