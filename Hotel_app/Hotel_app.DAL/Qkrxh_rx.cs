...
namespace Hotel_app.DAL
{
	...
	public partial class Qkrxh_rx
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qkrxh_rx"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qkrxh_rx");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Qkrxh_rx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Qkrxh_rx(");
			strSql.Append("yydh,qymc,xhrx,zjm,is_top,is_select)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@xhrx", SqlDbType.VarChar,50),
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Qkrxh_rx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Qkrxh_rx set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qkrxh_rx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Qkrxh_rx GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,xhrx,zjm,is_top,is_select from Qkrxh_rx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Qkrxh_rx model=new Hotel_app.Model.Qkrxh_rx();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,xhrx,zjm,is_top,is_select ");
			strSql.Append(" FROM Qkrxh_rx ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,xhrx,zjm,is_top,is_select ");
			strSql.Append(" FROM Qkrxh_rx ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qkrxh_rx T ");
