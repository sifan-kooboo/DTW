...
namespace Hotel_app.DAL
{
	...
	public partial class Szwzd_temp
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Szwzd_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Szwzd_temp");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Szwzd_temp(");
			strSql.Append("yydh,qymc,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,cznr,main_sec,is_top,is_select)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@cznr", SqlDbType.VarChar,100),
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Szwzd_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Szwzd_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Szwzd_temp GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,cznr,main_sec,is_top,is_select from Szwzd_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Szwzd_temp model=new Hotel_app.Model.Szwzd_temp();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,cznr,main_sec,is_top,is_select ");
			strSql.Append(" FROM Szwzd_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,cznr,main_sec,is_top,is_select ");
			strSql.Append(" FROM Szwzd_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Szwzd_temp T ");
