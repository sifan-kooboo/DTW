...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:VIEW_gz_jz_wj
	/// </summary>
	public partial class VIEW_gz_jz_wj
	{
		public VIEW_gz_jz_wj()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.VIEW_gz_jz_wj model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_gz_jz_wj(");
			strSql.Append("id,yydh,qymc,is_top,is_select,jzbh,id_app,lsbh,krxm,fjrb,fjbh,xfrq,sktt,xfsj,czy,xfdr,xfrb,xfxm,xfzy,xfbz,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czsj,syzd,is_visible,mxbh,jzzt,czzt,xydw,krly,ddsj,lksj,tfsj)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_gz_jz_wj model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_gz_jz_wj set ");
			strSql.Append("id=@id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_gz_jz_wj ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_gz_jz_wj GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,jzbh,id_app,lsbh,krxm,fjrb,fjbh,xfrq,sktt,xfsj,czy,xfdr,xfrb,xfxm,xfzy,xfbz,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czsj,syzd,is_visible,mxbh,jzzt,czzt,xydw,krly,ddsj,lksj,tfsj from VIEW_gz_jz_wj ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.VIEW_gz_jz_wj model=new Hotel_app.Model.VIEW_gz_jz_wj();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_top,is_select,jzbh,id_app,lsbh,krxm,fjrb,fjbh,xfrq,sktt,xfsj,czy,xfdr,xfrb,xfxm,xfzy,xfbz,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czsj,syzd,is_visible,mxbh,jzzt,czzt,xydw,krly,ddsj,lksj,tfsj ");
			strSql.Append(" FROM VIEW_gz_jz_wj ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_gz_jz_wj ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_gz_jz_wj T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_gz_jz_wj";
