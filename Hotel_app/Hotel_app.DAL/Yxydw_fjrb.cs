...
namespace Hotel_app.DAL
{
	...
	public partial class Yxydw_fjrb
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Yxydw_fjrb model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Yxydw_fjrb model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Yxydw_fjrb GetModel(int id)
		{
			...
			Hotel_app.Model.Yxydw_fjrb model=new Hotel_app.Model.Yxydw_fjrb();
