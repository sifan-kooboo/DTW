...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:VIEW_S_gz_ye
	/// </summary>
	public partial class VIEW_S_gz_ye
	{
		public VIEW_S_gz_ye()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.VIEW_S_gz_ye model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_S_gz_ye(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_S_gz_ye model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_S_gz_ye set ");
			strSql.Append("id=@id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_S_gz_ye ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_S_gz_ye GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,id_app,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,syzd,fkfs,mxbh,jzbh,xydw,xyh,jzzt,ddsj,czsj,tfsj,czy,czzt,krly from VIEW_S_gz_ye ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.VIEW_S_gz_ye model=new Hotel_app.Model.VIEW_S_gz_ye();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM VIEW_S_gz_ye ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_S_gz_ye ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_S_gz_ye T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_S_gz_ye";
