...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:View_Qskzd
	/// </summary>
	public partial class View_Qskzd
	{
		public View_Qskzd()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.View_Qskzd model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into View_Qskzd(");
			strSql.Append("yydh,qymc,lsbh,hykh,krxm,krly,xydw,xsy,ddsj,lksj,czy,czsj,sktt,fjrb,fjbh,lzfs,fjjg,fkje,xfje,id,ddbh,is_top,is_select,hyrx,tlkr,zjhm,qtyq,main_sec,yddj,zyzt,krgj,krmz,yxzj,krxb,krsr,krdh,krsj,krEmail,krdz,krjg,krdw,xyh,krrx,cznr,syzd,tsyq,ffzf,ffshys,sjfjjg,yh,yhbl,bz,cxmd,krzy,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,ddrx,ddwz,ddyy,kr_children,lzts,vip_type,ddly,shqh,jcje,fjbm,shsc)");
			...
			parameters[29].Value = model.zyzt;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.View_Qskzd model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update View_Qskzd set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from View_Qskzd ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.View_Qskzd GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 yydh,qymc,lsbh,hykh,krxm,krly,xydw,xsy,ddsj,lksj,czy,czsj,sktt,fjrb,fjbh,lzfs,fjjg,fkje,xfje,id,ddbh,is_top,is_select,hyrx,tlkr,zjhm,qtyq,main_sec,yddj,zyzt,krgj,krmz,yxzj,krxb,krsr,krdh,krsj,krEmail,krdz,krjg,krdw,xyh,krrx,cznr,syzd,tsyq,ffzf,ffshys,sjfjjg,yh,yhbl,bz,cxmd,krzy,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,ddrx,ddwz,ddyy,kr_children,lzts,vip_type,ddly,shqh,jcje,fjbm,shsc from View_Qskzd ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.View_Qskzd model=new Hotel_app.Model.View_Qskzd();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select yydh,qymc,lsbh,hykh,krxm,krly,xydw,xsy,ddsj,lksj,czy,czsj,sktt,fjrb,fjbh,lzfs,fjjg,fkje,xfje,id,ddbh,is_top,is_select,hyrx,tlkr,zjhm,qtyq,main_sec,yddj,zyzt,krgj,krmz,yxzj,krxb,krsr,krdh,krsj,krEmail,krdz,krjg,krdw,xyh,krrx,cznr,syzd,tsyq,ffzf,ffshys,sjfjjg,yh,yhbl,bz,cxmd,krzy,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,ddrx,ddwz,ddyy,kr_children,lzts,vip_type,ddly,shqh,jcje,fjbm,shsc ");
			strSql.Append(" FROM View_Qskzd ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM View_Qskzd ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from View_Qskzd T ");
