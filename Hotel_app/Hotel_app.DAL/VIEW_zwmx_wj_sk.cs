...
{
	/// <summary>
	/// 数据访问类:VIEW_zwmx_wj_sk
	/// </summary>
	public partial class VIEW_zwmx_wj_sk
	{
		public VIEW_zwmx_wj_sk()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.VIEW_zwmx_wj_sk model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_zwmx_wj_sk(");
			strSql.Append("id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,sktt,fjbh,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,ddsj,lksj,xydw,krly)");
			...
			parameters[33].Value = model.lksj;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_zwmx_wj_sk model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_zwmx_wj_sk set ");
			strSql.Append("id=@id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_zwmx_wj_sk ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_zwmx_wj_sk GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,sktt,fjbh,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,ddsj,lksj,xydw,krly from VIEW_zwmx_wj_sk ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.VIEW_zwmx_wj_sk model=new Hotel_app.Model.VIEW_zwmx_wj_sk();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,sktt,fjbh,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,ddsj,lksj,xydw,krly ");
			strSql.Append(" FROM VIEW_zwmx_wj_sk ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_zwmx_wj_sk ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_zwmx_wj_sk T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_zwmx_wj_sk";
