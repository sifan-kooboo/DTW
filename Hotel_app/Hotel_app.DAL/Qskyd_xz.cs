...
namespace Hotel_app.DAL
{
	...
	public partial class Qskyd_xz
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qskyd_xz"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qskyd_xz");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Qskyd_xz(");
			strSql.Append("yydh,qymc,lsbh,krxm,yddj,zjhm,fjrb,fjbh,ddsj,lksj,lksj_new,czy,czsj,is_top,is_select)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@lksj_new", SqlDbType.DateTime),
			...
			parameters[10].Value = model.lksj_new;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Qskyd_xz set ");
			...
			strSql.Append("lksj_new=@lksj_new,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qskyd_xz ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Qskyd_xz GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lsbh,krxm,yddj,zjhm,fjrb,fjbh,ddsj,lksj,lksj_new,czy,czsj,is_top,is_select from Qskyd_xz ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Qskyd_xz model=new Hotel_app.Model.Qskyd_xz();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["lksj_new"]!=null && ds.Tables[0].Rows[0]["lksj_new"].ToString()!="")
				{
					model.lksj_new=DateTime.Parse(ds.Tables[0].Rows[0]["lksj_new"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,lsbh,krxm,yddj,zjhm,fjrb,fjbh,ddsj,lksj,lksj_new,czy,czsj,is_top,is_select ");
			strSql.Append(" FROM Qskyd_xz ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,lsbh,krxm,yddj,zjhm,fjrb,fjbh,ddsj,lksj,lksj_new,czy,czsj,is_top,is_select ");
			strSql.Append(" FROM Qskyd_xz ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qskyd_xz T ");
