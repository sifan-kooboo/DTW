...
namespace Hotel_app.DAL
{
	...
	public partial class Xxfdr
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xxfdr"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xxfdr");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Xxfdr ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,drbh,xfdr,xfje,is_top,is_select,is_visible_bb ");
			strSql.Append(" FROM Xxfdr ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,drbh,xfdr,xfje,is_top,is_select,is_visible_bb ");
			strSql.Append(" FROM Xxfdr ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xxfdr T ");
