...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:Syjcz_jb_fs
	/// </summary>
	public partial class Syjcz_jb_fs
	{
		public Syjcz_jb_fs()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Syjcz_jb_fs"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Syjcz_jb_fs");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Syjcz_jb_fs model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Syjcz_jb_fs(");
			strSql.Append("yydh,qymc,jzbh,lsbh,lsbh_jb,id_app,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,fkfs,xfje,sjxfje,czy_bc,shsc,syzd,czzt)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Syjcz_jb_fs model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Syjcz_jb_fs set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Syjcz_jb_fs ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Syjcz_jb_fs GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,jzbh,lsbh,lsbh_jb,id_app,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,fkfs,xfje,sjxfje,czy_bc,shsc,syzd,czzt from Syjcz_jb_fs ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Syjcz_jb_fs model=new Hotel_app.Model.Syjcz_jb_fs();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,jzbh,lsbh,lsbh_jb,id_app,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,fkfs,xfje,sjxfje,czy_bc,shsc,syzd,czzt ");
			strSql.Append(" FROM Syjcz_jb_fs ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,jzbh,lsbh,lsbh_jb,id_app,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,fkfs,xfje,sjxfje,czy_bc,shsc,syzd,czzt ");
			strSql.Append(" FROM Syjcz_jb_fs ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Syjcz_jb_fs T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Syjcz_jb_fs";
