...
{
	/// <summary>
	/// 数据访问类:VIEW_syxf_kc_temp
	/// </summary>
	public partial class VIEW_syxf_kc_temp
	{
		public VIEW_syxf_kc_temp()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.VIEW_syxf_kc_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_syxf_kc_temp(");
			strSql.Append("yydh,id,qymc,is_top,is_select,lsbh_jk,czsj_jk,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,shbd,is_tj_kc)");
			...
			parameters[5].Value = model.lsbh_jk;
			parameters[6].Value = model.czsj_jk;
			parameters[7].Value = model.id_app;
			parameters[8].Value = model.jzbh;
			parameters[9].Value = model.lsbh;
			parameters[10].Value = model.krxm;
			parameters[11].Value = model.fjrb;
			parameters[12].Value = model.fjbh;
			parameters[13].Value = model.sktt;
			parameters[14].Value = model.xfrq;
			parameters[15].Value = model.xfsj;
			parameters[16].Value = model.czy;
			parameters[17].Value = model.xfdr;
			parameters[18].Value = model.xfrb;
			parameters[19].Value = model.xfxm;
			parameters[20].Value = model.xfbz;
			parameters[21].Value = model.xfzy;
			parameters[22].Value = model.jjje;
			parameters[23].Value = model.xfje;
			parameters[24].Value = model.yh;
			parameters[25].Value = model.sjxfje;
			parameters[26].Value = model.xfsl;
			parameters[27].Value = model.shsc;
			parameters[28].Value = model.czy_bc;
			parameters[29].Value = model.is_visible;
			parameters[30].Value = model.mxbh;
			parameters[31].Value = model.shbd;
			parameters[32].Value = model.is_tj_kc;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_syxf_kc_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_syxf_kc_temp set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_syxf_kc_temp ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_syxf_kc_temp GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 yydh,id,qymc,is_top,is_select,lsbh_jk,czsj_jk,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,shbd,is_tj_kc from VIEW_syxf_kc_temp ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.VIEW_syxf_kc_temp model=new Hotel_app.Model.VIEW_syxf_kc_temp();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select yydh,id,qymc,is_top,is_select,lsbh_jk,czsj_jk,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,shbd,is_tj_kc ");
			strSql.Append(" FROM VIEW_syxf_kc_temp ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_syxf_kc_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_syxf_kc_temp T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_syxf_kc_temp";
