...
namespace Hotel_app.DAL
{
	...
	public partial class BB_zdkr_ylfx_temp
	{
		...
		public int Add(Hotel_app.Model.BB_zdkr_ylfx_temp model)
		{
			...
			strSql.Append("insert into BB_zdkr_ylfx_temp(");
			strSql.Append("qymc,yydh,lsbh,krxm,krly,xydw,xsy,ddsj,lksj,czy,sktt,fjrb,fjbh,lzrs,lzfs,sjfjjg,ddbh,zjhm,bz,czy_temp,ylrq,main_sec)");
			...
			parameters[15].Value = model.sjfjjg;
			...
			parameters[20].Value = model.ylrq;
			parameters[21].Value = model.main_sec;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BB_zdkr_ylfx_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BB_zdkr_ylfx_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.BB_zdkr_ylfx_temp GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,qymc,yydh,lsbh,krxm,krly,xydw,xsy,ddsj,lksj,czy,sktt,fjrb,fjbh,lzrs,lzfs,sjfjjg,ddbh,zjhm,bz,czy_temp,ylrq,main_sec from BB_zdkr_ylfx_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.BB_zdkr_ylfx_temp model=new Hotel_app.Model.BB_zdkr_ylfx_temp();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,qymc,yydh,lsbh,krxm,krly,xydw,xsy,ddsj,lksj,czy,sktt,fjrb,fjbh,lzrs,lzfs,sjfjjg,ddbh,zjhm,bz,czy_temp,ylrq,main_sec ");
			strSql.Append(" FROM BB_zdkr_ylfx_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,qymc,yydh,lsbh,krxm,krly,xydw,xsy,ddsj,lksj,czy,sktt,fjrb,fjbh,lzrs,lzfs,sjfjjg,ddbh,zjhm,bz,czy_temp,ylrq,main_sec ");
			strSql.Append(" FROM BB_zdkr_ylfx_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM BB_zdkr_ylfx_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BB_zdkr_ylfx_temp T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BB_zdkr_ylfx_temp";
