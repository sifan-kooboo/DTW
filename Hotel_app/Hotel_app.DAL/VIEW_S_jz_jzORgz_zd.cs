...
{
	/// <summary>
	/// 数据访问类:VIEW_S_jz_jzORgz_zd
	/// </summary>
	public partial class VIEW_S_jz_jzORgz_zd
	{
		public VIEW_S_jz_jzORgz_zd()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.VIEW_S_jz_jzORgz_zd model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_S_jz_jzORgz_zd(");
			strSql.Append("yydh,qymc,jzbh,lsbh,is_top,is_select,krxm,sktt,fjbh,xydw,krly,tfsj,czsj,czy,czzt,xyh,jzzt,sdcz,syzd,bz,fp_print,is_visible,fkje,xfje,shsc,shys,ddsj,krxm_lz,fjbh_lz)");
			...
			parameters[11].Value = model.tfsj;
			parameters[12].Value = model.czsj;
			parameters[13].Value = model.czy;
			parameters[14].Value = model.czzt;
			parameters[15].Value = model.xyh;
			parameters[16].Value = model.jzzt;
			parameters[17].Value = model.sdcz;
			parameters[18].Value = model.syzd;
			parameters[19].Value = model.bz;
			parameters[20].Value = model.fp_print;
			parameters[21].Value = model.is_visible;
			parameters[22].Value = model.fkje;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_S_jz_jzORgz_zd model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_S_jz_jzORgz_zd set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_S_jz_jzORgz_zd ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_S_jz_jzORgz_zd GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,jzbh,lsbh,is_top,is_select,krxm,sktt,fjbh,xydw,krly,tfsj,czsj,czy,czzt,xyh,jzzt,sdcz,syzd,bz,fp_print,is_visible,fkje,xfje,shsc,shys,ddsj,krxm_lz,fjbh_lz from VIEW_S_jz_jzORgz_zd ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.VIEW_S_jz_jzORgz_zd model=new Hotel_app.Model.VIEW_S_jz_jzORgz_zd();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM VIEW_S_jz_jzORgz_zd ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_S_jz_jzORgz_zd ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_S_jz_jzORgz_zd T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_S_jz_jzORgz_zd";
