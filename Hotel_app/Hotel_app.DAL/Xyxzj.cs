...
namespace Hotel_app.DAL
{
	...
	public partial class Xyxzj
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xyxzj"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xyxzj");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Xyxzj ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,yxzj,zjm,is_top,is_select ");
			strSql.Append(" FROM Xyxzj ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,yxzj,zjm,is_top,is_select ");
			strSql.Append(" FROM Xyxzj ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xyxzj T ");
