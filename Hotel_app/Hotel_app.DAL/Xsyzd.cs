...
namespace Hotel_app.DAL
{
	...
	public partial class Xsyzd
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xsyzd"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xsyzd");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Xsyzd model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Xsyzd(");
			strSql.Append("yydh,qymc,syzd,zjm,is_top,is_select)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Xsyzd model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Xsyzd set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Xsyzd ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Xsyzd GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,syzd,zjm,is_top,is_select from Xsyzd ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Xsyzd model=new Hotel_app.Model.Xsyzd();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,syzd,zjm,is_top,is_select ");
			strSql.Append(" FROM Xsyzd ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,syzd,zjm,is_top,is_select ");
			strSql.Append(" FROM Xsyzd ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xsyzd T ");
