...
namespace Hotel_app.DAL
{
	...
	public partial class Hhyjb
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Hhyjb"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Hhyjb");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Hhyjb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Hhyjb GetModel(int id)
		{
			...
			Hotel_app.Model.Hhyjb model=new Hotel_app.Model.Hhyjb();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,jbxs,hyrx,dfjf,is_top,is_select ");
			strSql.Append(" FROM Hhyjb ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,jbxs,hyrx,dfjf,is_top,is_select ");
			strSql.Append(" FROM Hhyjb ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Hhyjb T ");
