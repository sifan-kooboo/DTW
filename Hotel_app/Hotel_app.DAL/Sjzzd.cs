...
namespace Hotel_app.DAL
{
	...
	public partial class Sjzzd
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Sjzzd"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Sjzzd");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Sjzzd(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Sjzzd set ");
		...
		public Hotel_app.Model.Sjzzd GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,jzbh,lsbh,is_top,is_select,krxm,sktt,fjbh,xydw,krly,tfsj,czsj,czy,czzt,xyh,jzzt,sdcz,syzd,bz,fp_print,is_visible,fkje,xfje,shsc,shys,ddsj,krxm_lz,fjbh_lz from Sjzzd ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Sjzzd model=new Hotel_app.Model.Sjzzd();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Sjzzd T ");
