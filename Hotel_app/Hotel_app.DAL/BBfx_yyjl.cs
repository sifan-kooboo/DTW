...
namespace Hotel_app.DAL
{
	...
	public partial class BBfx_yyjl
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "BBfx_yyjl"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from BBfx_yyjl");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.BBfx_yyjl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BBfx_yyjl(");
			strSql.Append("yydh,qymc,sbzd,xfrb,sjxfje,czy_temp,y_r,y_z_w,bbrq)");
			...
			parameters[5].Value = model.czy_temp;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.BBfx_yyjl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BBfx_yyjl set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BBfx_yyjl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.BBfx_yyjl GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,sbzd,xfrb,sjxfje,czy_temp,y_r,y_z_w,bbrq from BBfx_yyjl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.BBfx_yyjl model=new Hotel_app.Model.BBfx_yyjl();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,sbzd,xfrb,sjxfje,czy_temp,y_r,y_z_w,bbrq ");
			strSql.Append(" FROM BBfx_yyjl ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,sbzd,xfrb,sjxfje,czy_temp,y_r,y_z_w,bbrq ");
			strSql.Append(" FROM BBfx_yyjl ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BBfx_yyjl T ");
