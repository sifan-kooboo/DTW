...
namespace Hotel_app.DAL
{
	...
	public partial class Xqzrx
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xqzrx"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xqzrx");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Xqzrx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Xqzrx(");
			strSql.Append("yydh,qymc,qzrx,zjm,is_top,is_select)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Xqzrx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Xqzrx set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Xqzrx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Xqzrx GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,qzrx,zjm,is_top,is_select from Xqzrx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Xqzrx model=new Hotel_app.Model.Xqzrx();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,qzrx,zjm,is_top,is_select ");
			strSql.Append(" FROM Xqzrx ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,qzrx,zjm,is_top,is_select ");
			strSql.Append(" FROM Xqzrx ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xqzrx T ");
