...
namespace Hotel_app.DAL
{
	...
	public partial class Yxsy
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Yxsy"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Yxsy");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Yxsy(");
			strSql.Append("yydh,qymc,xs_level,xsy,zjm,is_top,is_select)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@xs_level", SqlDbType.Int,4),
			...
			parameters[2].Value = model.xs_level;
			parameters[3].Value = model.xsy;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Yxsy set ");
			strSql.Append("yydh=@yydh,");
			strSql.Append("qymc=@qymc,");
			strSql.Append("xs_level=@xs_level,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Yxsy ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Yxsy GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,xs_level,xsy,zjm,is_top,is_select from Yxsy ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Yxsy model=new Hotel_app.Model.Yxsy();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["xs_level"]!=null && ds.Tables[0].Rows[0]["xs_level"].ToString()!="")
				{
					model.xs_level=int.Parse(ds.Tables[0].Rows[0]["xs_level"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,xs_level,xsy,zjm,is_top,is_select ");
			strSql.Append(" FROM Yxsy ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,xs_level,xsy,zjm,is_top,is_select ");
			strSql.Append(" FROM Yxsy ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Yxsy T ");
