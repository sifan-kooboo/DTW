...
{
	/// <summary>
	/// 数据访问类:View_zdkr_ylfx_temp
	/// </summary>
	public partial class View_zdkr_ylfx_temp
	{
		public View_zdkr_ylfx_temp()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.View_zdkr_ylfx_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into View_zdkr_ylfx_temp(");
			strSql.Append("jdlh_name,jdcs_name,id,qymc,yydh,lsbh,krxm,krly,xydw,xsy,ddsj,lksj,czy,sktt,fjrb,fjbh,lzrs,lzfs,sjfjjg,ddbh,zjhm,bz,czy_temp,ylrq,main_sec,Expr1,Expr2,zyzt)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@sjfjjg", SqlDbType.Float,8),
			...
			parameters[23].Value = model.ylrq;
			parameters[24].Value = model.main_sec;
			parameters[25].Value = model.Expr1;
			parameters[26].Value = model.Expr2;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.View_zdkr_ylfx_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update View_zdkr_ylfx_temp set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from View_zdkr_ylfx_temp ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.View_zdkr_ylfx_temp GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 jdlh_name,jdcs_name,id,qymc,yydh,lsbh,krxm,krly,xydw,xsy,ddsj,lksj,czy,sktt,fjrb,fjbh,lzrs,lzfs,sjfjjg,ddbh,zjhm,bz,czy_temp,ylrq,main_sec,Expr1,Expr2,zyzt from View_zdkr_ylfx_temp ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.View_zdkr_ylfx_temp model=new Hotel_app.Model.View_zdkr_ylfx_temp();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["ylrq"]!=null && ds.Tables[0].Rows[0]["ylrq"].ToString()!="")
				{
					model.ylrq=DateTime.Parse(ds.Tables[0].Rows[0]["ylrq"].ToString());
				}
				...
				{
					model.Expr2=ds.Tables[0].Rows[0]["Expr2"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select jdlh_name,jdcs_name,id,qymc,yydh,lsbh,krxm,krly,xydw,xsy,ddsj,lksj,czy,sktt,fjrb,fjbh,lzrs,lzfs,sjfjjg,ddbh,zjhm,bz,czy_temp,ylrq,main_sec,Expr1,Expr2,zyzt ");
			strSql.Append(" FROM View_zdkr_ylfx_temp ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM View_zdkr_ylfx_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from View_zdkr_ylfx_temp T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "View_zdkr_ylfx_temp";
