...
namespace Hotel_app.DAL
{
	...
	public partial class Yxydw
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Yxydw"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Yxydw");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Yxydw model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Yxydw(");
			strSql.Append("krly,yydh,qymc,xyrx,krgj,pq,xyh,xyh_inner,rx,xydw,zjm,nxr,krdh,krcz,krEmail,krdz,xsy,shsc,bz,lzfs,fkje,xfje,clsj,xzxg,is_top,is_select,shsh,sign_image,xsed)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@xsed", SqlDbType.Decimal,5)};
			...
			parameters[28].Value = model.xsed;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Yxydw model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Yxydw set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Yxydw ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Yxydw GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,krly,yydh,qymc,xyrx,krgj,pq,xyh,xyh_inner,rx,xydw,zjm,nxr,krdh,krcz,krEmail,krdz,xsy,shsc,bz,lzfs,fkje,xfje,clsj,xzxg,is_top,is_select,shsh,sign_image,xsed from Yxydw ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Yxydw model=new Hotel_app.Model.Yxydw();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["xsed"]!=null && ds.Tables[0].Rows[0]["xsed"].ToString()!="")
				{
					model.xsed=decimal.Parse(ds.Tables[0].Rows[0]["xsed"].ToString());
				}
				return model;
			}
			else
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,krly,yydh,qymc,xyrx,krgj,pq,xyh,xyh_inner,rx,xydw,zjm,nxr,krdh,krcz,krEmail,krdz,xsy,shsc,bz,lzfs,fkje,xfje,clsj,xzxg,is_top,is_select,shsh,sign_image,xsed ");
			strSql.Append(" FROM Yxydw ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,krly,yydh,qymc,xyrx,krgj,pq,xyh,xyh_inner,rx,xydw,zjm,nxr,krdh,krcz,krEmail,krdz,xsy,shsc,bz,lzfs,fkje,xfje,clsj,xzxg,is_top,is_select,shsh,sign_image,xsed ");
			strSql.Append(" FROM Yxydw ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Yxydw T ");
