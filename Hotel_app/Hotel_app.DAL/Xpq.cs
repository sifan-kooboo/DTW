...
namespace Hotel_app.DAL
{
	...
	public partial class Xpq
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xpq"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xpq");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Xpq model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Xpq(");
			strSql.Append("yydh,qymc,pq,zjm,is_select,is_top)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Xpq model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Xpq set ");
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Xpq GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,pq,zjm,is_select,is_top from Xpq ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Xpq model=new Hotel_app.Model.Xpq();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,pq,zjm,is_select,is_top ");
			strSql.Append(" FROM Xpq ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,pq,zjm,is_select,is_top ");
			strSql.Append(" FROM Xpq ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xpq T ");
