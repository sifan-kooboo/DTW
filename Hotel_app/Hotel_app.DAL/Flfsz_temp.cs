...
namespace Hotel_app.DAL
{
	...
	public partial class Flfsz_temp
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Flfsz_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Flfsz_temp");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Flfsz_temp(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Flfsz_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Flfsz_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public Hotel_app.Model.Flfsz_temp GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lfbh,lsbh,fjbh,krxm,sktt,yddj,czy,cznr,czsj,shlz,is_top,is_select from Flfsz_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Flfsz_temp model=new Hotel_app.Model.Flfsz_temp();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Flfsz_temp T ");
