...
namespace Hotel_app.DAL
{
	...
	public partial class Xkrrx
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xkrrx"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xkrrx");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Xkrrx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Xkrrx(");
			strSql.Append("yydh,qymc,krrx,zjm,is_top,is_select)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Xkrrx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Xkrrx set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Xkrrx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Xkrrx GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,krrx,zjm,is_top,is_select from Xkrrx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Xkrrx model=new Hotel_app.Model.Xkrrx();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,krrx,zjm,is_top,is_select ");
			strSql.Append(" FROM Xkrrx ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,krrx,zjm,is_top,is_select ");
			strSql.Append(" FROM Xkrrx ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xkrrx T ");
