...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:Szwzd_bak
	/// </summary>
	public partial class Szwzd_bak
	{
		public Szwzd_bak()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Szwzd_bak"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Szwzd_bak");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Szwzd_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Szwzd_bak(");
			strSql.Append("yydh,qymc,jzbh,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,main_sec,is_top,is_select)");
			...
			parameters[8].Value = model.fkje;
			parameters[9].Value = model.xfje;
			parameters[10].Value = model.main_sec;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Szwzd_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Szwzd_bak set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Szwzd_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Szwzd_bak GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,jzbh,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,main_sec,is_top,is_select from Szwzd_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Szwzd_bak model=new Hotel_app.Model.Szwzd_bak();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,jzbh,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,main_sec,is_top,is_select ");
			strSql.Append(" FROM Szwzd_bak ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,jzbh,lsbh,krxm,sktt,yddj,fjbh,fkje,xfje,main_sec,is_top,is_select ");
			strSql.Append(" FROM Szwzd_bak ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Szwzd_bak T ");
