...
{
	/// <summary>
	/// 数据访问类:Qttyd_mainrecord_bak
	/// </summary>
	public partial class Qttyd_mainrecord_bak
	{
		public Qttyd_mainrecord_bak()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qttyd_mainrecord_bak"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qttyd_mainrecord_bak");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Qttyd_mainrecord_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Qttyd_mainrecord_bak(");
			strSql.Append("yydh,qymc,jzbh,lsbh,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,ddly)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Qttyd_mainrecord_bak model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Qttyd_mainrecord_bak set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qttyd_mainrecord_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Qttyd_mainrecord_bak GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,jzbh,lsbh,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,ddly from Qttyd_mainrecord_bak ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Qttyd_mainrecord_bak model=new Hotel_app.Model.Qttyd_mainrecord_bak();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,jzbh,lsbh,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,ddly ");
			strSql.Append(" FROM Qttyd_mainrecord_bak ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,jzbh,lsbh,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,ddly ");
			strSql.Append(" FROM Qttyd_mainrecord_bak ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qttyd_mainrecord_bak T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Qttyd_mainrecord_bak";
