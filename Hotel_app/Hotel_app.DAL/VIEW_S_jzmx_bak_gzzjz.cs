...
{
	/// <summary>
	/// 数据访问类:VIEW_S_jzmx_bak_gzzjz
	/// </summary>
	public partial class VIEW_S_jzmx_bak_gzzjz
	{
		public VIEW_S_jzmx_bak_gzzjz()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_S_jzmx_bak_gzzjz(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_S_jzmx_bak_gzzjz set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_S_jzmx_bak_gzzjz ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,jzbh_new,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,tfsj,czsj,syzd,is_visible,xyh,jzzt,fkfs,mxbh from VIEW_S_jzmx_bak_gzzjz ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz model=new Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM VIEW_S_jzmx_bak_gzzjz ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_S_jzmx_bak_gzzjz ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_S_jzmx_bak_gzzjz T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_S_jzmx_bak_gzzjz";
