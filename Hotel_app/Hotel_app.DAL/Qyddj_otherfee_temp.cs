...
{
	/// <summary>
	/// 数据访问类:Qyddj_otherfee_temp
	/// </summary>
	public partial class Qyddj_otherfee_temp
	{
		public Qyddj_otherfee_temp()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qyddj_otherfee_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qyddj_otherfee_temp");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Qyddj_otherfee_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Qyddj_otherfee_temp(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Qyddj_otherfee_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Qyddj_otherfee_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qyddj_otherfee_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Qyddj_otherfee_temp GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_select,is_top,lsbh,krxm,sktt,fjbh,fyrx,xfdr,xfrb,xfxm,xfsl,jjje,xfje,shsc,czy,cznr,czsj,sdcz,mxbh from Qyddj_otherfee_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Qyddj_otherfee_temp model=new Hotel_app.Model.Qyddj_otherfee_temp();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Qyddj_otherfee_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qyddj_otherfee_temp T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Qyddj_otherfee_temp";
