...
{
	/// <summary>
	/// 数据访问类:VIEW_zwmx_wj_tt
	/// </summary>
	public partial class VIEW_zwmx_wj_tt
	{
		public VIEW_zwmx_wj_tt()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.VIEW_zwmx_wj_tt model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into VIEW_zwmx_wj_tt(");
			strSql.Append("id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfzy,xfbz,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,xydw,krly,lksj,ddsj,krxm_tt)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@krxm_tt", SqlDbType.VarChar,50)};
			...
			parameters[33].Value = model.krly;
			parameters[34].Value = model.lksj;
			parameters[35].Value = model.ddsj;
			parameters[36].Value = model.krxm_tt;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.VIEW_zwmx_wj_tt model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update VIEW_zwmx_wj_tt set ");
			strSql.Append("id=@id,");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from VIEW_zwmx_wj_tt ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.VIEW_zwmx_wj_tt GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfzy,xfbz,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,xydw,krly,lksj,ddsj,krxm_tt from VIEW_zwmx_wj_tt ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.VIEW_zwmx_wj_tt model=new Hotel_app.Model.VIEW_zwmx_wj_tt();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["krxm_tt"]!=null && ds.Tables[0].Rows[0]["krxm_tt"].ToString()!="")
				{
					model.krxm_tt=ds.Tables[0].Rows[0]["krxm_tt"].ToString();
				}
				return model;
			}
			else
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfzy,xfbz,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,xydw,krly,lksj,ddsj,krxm_tt ");
			strSql.Append(" FROM VIEW_zwmx_wj_tt ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM VIEW_zwmx_wj_tt ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from VIEW_zwmx_wj_tt T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "VIEW_zwmx_wj_tt";
