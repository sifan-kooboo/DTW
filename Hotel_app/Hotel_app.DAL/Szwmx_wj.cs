...
namespace Hotel_app.DAL
{
	...
	public partial class Szwmx_wj
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Szwmx_wj"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Szwmx_wj");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Szwmx_wj model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Szwmx_wj(");
			strSql.Append("yydh,qymc,is_top,is_select,lsbh_jk,czsj_jk,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,jzzt,ddsj,lksj,krly,xydw)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@czsj_jk", SqlDbType.DateTime),
			...
			parameters[28].Value = model.czzt;
			parameters[29].Value = model.czsj;
			parameters[30].Value = model.syzd;
			parameters[31].Value = model.is_visible;
			parameters[32].Value = model.mxbh;
			parameters[33].Value = model.jzzt;
			parameters[34].Value = model.ddsj;
			parameters[35].Value = model.lksj;
			parameters[36].Value = model.krly;
			parameters[37].Value = model.xydw;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Szwmx_wj model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Szwmx_wj set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Szwmx_wj ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Szwmx_wj GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,lsbh_jk,czsj_jk,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,jzzt,ddsj,lksj,krly,xydw from Szwmx_wj ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Szwmx_wj model=new Hotel_app.Model.Szwmx_wj();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				{
					model.czsj_jk=DateTime.Parse(ds.Tables[0].Rows[0]["czsj_jk"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_top,is_select,lsbh_jk,czsj_jk,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,jzzt,ddsj,lksj,krly,xydw ");
			strSql.Append(" FROM Szwmx_wj ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,is_top,is_select,lsbh_jk,czsj_jk,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,czzt,czsj,syzd,is_visible,mxbh,jzzt,ddsj,lksj,krly,xydw ");
			strSql.Append(" FROM Szwmx_wj ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Szwmx_wj T ");
