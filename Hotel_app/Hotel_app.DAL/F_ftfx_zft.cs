...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:F_ftfx_zft
	/// </summary>
	public partial class F_ftfx_zft
	{
		public F_ftfx_zft()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "F_ftfx_zft"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from F_ftfx_zft");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.F_ftfx_zft model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into F_ftfx_zft(");
			strSql.Append("yydh,qymc,zyzt,zyfs,is_top,is_select,czy)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.F_ftfx_zft model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update F_ftfx_zft set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from F_ftfx_zft ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.F_ftfx_zft GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,zyzt,zyfs,is_top,is_select,czy from F_ftfx_zft ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.F_ftfx_zft model=new Hotel_app.Model.F_ftfx_zft();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,zyzt,zyfs,is_top,is_select,czy ");
			strSql.Append(" FROM F_ftfx_zft ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,zyzt,zyfs,is_top,is_select,czy ");
			strSql.Append(" FROM F_ftfx_zft ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from F_ftfx_zft T ");
