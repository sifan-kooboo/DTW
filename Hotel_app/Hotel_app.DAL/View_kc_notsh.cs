...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:View_kc_notsh
	/// </summary>
	public partial class View_kc_notsh
	{
		public View_kc_notsh()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Hotel_app.Model.View_kc_notsh model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into View_kc_notsh(");
			strSql.Append("yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfsj,xfrq,czy,xfdr,xfrb,xfxm,xfbz,jjje,xfzy,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,ddsj,lksj,czsj,id,xftm)");
			...
			parameters[32].Value = model.xftm;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.View_kc_notsh model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update View_kc_notsh set ");
		...
		public bool Delete()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from View_kc_notsh ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.View_kc_notsh GetModel()
		{
			//该表无主键信息，请自定义主键/条件字段
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfsj,xfrq,czy,xfdr,xfrb,xfxm,xfbz,jjje,xfzy,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,ddsj,lksj,czsj,id,xftm from View_kc_notsh ");
			strSql.Append(" where ");
			SqlParameter[] parameters = {
			};

			Hotel_app.Model.View_kc_notsh model=new Hotel_app.Model.View_kc_notsh();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfsj,xfrq,czy,xfdr,xfrb,xfxm,xfbz,jjje,xfzy,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh,ddsj,lksj,czsj,id,xftm ");
			strSql.Append(" FROM View_kc_notsh ");
			if(strWhere.Trim()!="")
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) FROM View_kc_notsh ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
			}
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from View_kc_notsh T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "View_kc_notsh";
