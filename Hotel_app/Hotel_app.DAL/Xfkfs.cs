...
namespace Hotel_app.DAL
{
	...
	public partial class Xfkfs
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Xfkfs"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Xfkfs");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Xfkfs model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Xfkfs(");
			strSql.Append("yydh,qymc,fkfs,zjm,is_top,is_select,is_visible_bb)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Xfkfs model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Xfkfs set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Xfkfs ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Xfkfs GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,fkfs,zjm,is_top,is_select,is_visible_bb from Xfkfs ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Xfkfs model=new Hotel_app.Model.Xfkfs();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,fkfs,zjm,is_top,is_select,is_visible_bb ");
			strSql.Append(" FROM Xfkfs ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,fkfs,zjm,is_top,is_select,is_visible_bb ");
			strSql.Append(" FROM Xfkfs ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Xfkfs T ");
