...
namespace Hotel_app.DAL
{
	...
	/// 数据访问类:Ffjzt_temp
	/// </summary>
	public partial class Ffjzt_temp
	{
		public Ffjzt_temp()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Ffjzt_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Ffjzt_temp");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Ffjzt_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ffjzt_temp(");
			strSql.Append("yydh,qymc,zyzt,zyzt_second,zybz,fjrb_code,fjrb,fjbh,fjdh,dhfj,jdlh,jdlh_name,jdcs,jdcs_name,krxm,ddsj,lksj,yd_ddsj,yd_lksj,bz,shlf,shts,shvip,lsbh,sktt,is_select,is_top,use_time,is_secret,czsj,cznr,czy)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Ffjzt_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ffjzt_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ffjzt_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Ffjzt_temp GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,zyzt,zyzt_second,zybz,fjrb_code,fjrb,fjbh,fjdh,dhfj,jdlh,jdlh_name,jdcs,jdcs_name,krxm,ddsj,lksj,yd_ddsj,yd_lksj,bz,shlf,shts,shvip,lsbh,sktt,is_select,is_top,use_time,is_secret,czsj,cznr,czy from Ffjzt_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
			...
			Hotel_app.Model.Ffjzt_temp model=new Hotel_app.Model.Ffjzt_temp();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,zyzt,zyzt_second,zybz,fjrb_code,fjrb,fjbh,fjdh,dhfj,jdlh,jdlh_name,jdcs,jdcs_name,krxm,ddsj,lksj,yd_ddsj,yd_lksj,bz,shlf,shts,shvip,lsbh,sktt,is_select,is_top,use_time,is_secret,czsj,cznr,czy ");
			strSql.Append(" FROM Ffjzt_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,zyzt,zyzt_second,zybz,fjrb_code,fjrb,fjbh,fjdh,dhfj,jdlh,jdlh_name,jdcs,jdcs_name,krxm,ddsj,lksj,yd_ddsj,yd_lksj,bz,shlf,shts,shvip,lsbh,sktt,is_select,is_top,use_time,is_secret,czsj,cznr,czy ");
			strSql.Append(" FROM Ffjzt_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Ffjzt_temp T ");
