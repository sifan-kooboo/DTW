...
namespace Hotel_app.DAL
{
	...
	public partial class Fwx_other_temp
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Hotel_app.Model.Fwx_other_temp model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Fwx_other_temp model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Fwx_other_temp GetModel(int id)
		{
			...
			Hotel_app.Model.Fwx_other_temp model=new Hotel_app.Model.Fwx_other_temp();
