...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_zwmx_wj_sk dal=new Hotel_app.DAL.VIEW_zwmx_wj_sk();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_zwmx_wj_sk GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "VIEW_zwmx_wj_skModel-" ;
			...
			return (Hotel_app.Model.VIEW_zwmx_wj_sk)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_zwmx_wj_sk> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_zwmx_wj_sk> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_zwmx_wj_sk> modelList = new List<Hotel_app.Model.VIEW_zwmx_wj_sk>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_zwmx_wj_sk model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_zwmx_wj_sk();
