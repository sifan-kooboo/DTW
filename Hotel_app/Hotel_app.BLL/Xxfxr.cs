...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Xxfxr dal=new Hotel_app.DAL.Xxfxr();
		public Xxfxr()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Xxfxr GetModelByCache(int id)
		{
			
			string CacheKey = "XxfxrModel-" + id;
			...
			return (Hotel_app.Model.Xxfxr)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Xxfxr> GetModelList(string strWhere)
		{
