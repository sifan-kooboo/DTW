...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.View_Qttzd dal=new Hotel_app.DAL.View_Qttzd();
		public View_Qttzd()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.View_Qttzd GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "View_QttzdModel-" ;
			...
			return (Hotel_app.Model.View_Qttzd)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_Qttzd> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_Qttzd> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.View_Qttzd> modelList = new List<Hotel_app.Model.View_Qttzd>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.View_Qttzd model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.View_Qttzd();
