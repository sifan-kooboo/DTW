...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Ssyxfmx_bb_ls dal=new Hotel_app.DAL.Ssyxfmx_bb_ls();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Ssyxfmx_bb_ls GetModelByCache(int id)
		{
			
			string CacheKey = "Ssyxfmx_bb_lsModel-" + id;
			...
			return (Hotel_app.Model.Ssyxfmx_bb_ls)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ssyxfmx_bb_ls> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ssyxfmx_bb_ls> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Ssyxfmx_bb_ls> modelList = new List<Hotel_app.Model.Ssyxfmx_bb_ls>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Ssyxfmx_bb_ls model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Ssyxfmx_bb_ls();
