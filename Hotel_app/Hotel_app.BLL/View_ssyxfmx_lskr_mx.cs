...
{
	/// <summary>
	/// View_ssyxfmx_lskr_mx
	/// </summary>
	public partial class View_ssyxfmx_lskr_mx
	{
		private readonly Hotel_app.DAL.View_ssyxfmx_lskr_mx dal=new Hotel_app.DAL.View_ssyxfmx_lskr_mx();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.View_ssyxfmx_lskr_mx GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "View_ssyxfmx_lskr_mxModel-" ;
			...
			return (Hotel_app.Model.View_ssyxfmx_lskr_mx)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_ssyxfmx_lskr_mx> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_ssyxfmx_lskr_mx> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.View_ssyxfmx_lskr_mx> modelList = new List<Hotel_app.Model.View_ssyxfmx_lskr_mx>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.View_ssyxfmx_lskr_mx model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.View_ssyxfmx_lskr_mx();
