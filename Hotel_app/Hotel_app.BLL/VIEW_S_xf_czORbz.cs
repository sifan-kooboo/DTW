...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_S_xf_czORbz dal=new Hotel_app.DAL.VIEW_S_xf_czORbz();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_xf_czORbz GetModelByCache(int id)
		{
			
			string CacheKey = "VIEW_S_xf_czORbzModel-" + id;
			...
			return (Hotel_app.Model.VIEW_S_xf_czORbz)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_xf_czORbz> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_xf_czORbz> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_xf_czORbz> modelList = new List<Hotel_app.Model.VIEW_S_xf_czORbz>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_xf_czORbz model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_xf_czORbz();
