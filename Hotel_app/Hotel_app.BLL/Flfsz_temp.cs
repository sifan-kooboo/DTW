...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Flfsz_temp dal=new Hotel_app.DAL.Flfsz_temp();
		public Flfsz_temp()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(Hotel_app.Model.Flfsz_temp model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Flfsz_temp model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Flfsz_temp GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Flfsz_temp GetModelByCache(int id)
		{
			
			string CacheKey = "Flfsz_tempModel-" + id;
			...
			return (Hotel_app.Model.Flfsz_temp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Flfsz_temp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Flfsz_temp> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Flfsz_temp> modelList = new List<Hotel_app.Model.Flfsz_temp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Flfsz_temp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Flfsz_temp();
					...
					if(dt.Rows[n]["lfbh"]!=null && dt.Rows[n]["lfbh"].ToString()!="")
					{
					model.lfbh=dt.Rows[n]["lfbh"].ToString();
					}
