...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.F_ftfx_7days dal=new Hotel_app.DAL.F_ftfx_7days();
		public F_ftfx_7days()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.F_ftfx_7days GetModelByCache(int id)
		{
			
			string CacheKey = "F_ftfx_7daysModel-" + id;
			...
			return (Hotel_app.Model.F_ftfx_7days)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.F_ftfx_7days> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.F_ftfx_7days> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.F_ftfx_7days> modelList = new List<Hotel_app.Model.F_ftfx_7days>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.F_ftfx_7days model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.F_ftfx_7days();
