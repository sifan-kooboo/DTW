...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_S_xf_syxf dal=new Hotel_app.DAL.VIEW_S_xf_syxf();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_xf_syxf GetModelByCache(int id)
		{
			
			string CacheKey = "VIEW_S_xf_syxfModel-" + id;
			...
			return (Hotel_app.Model.VIEW_S_xf_syxf)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_xf_syxf> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_xf_syxf> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_xf_syxf> modelList = new List<Hotel_app.Model.VIEW_S_xf_syxf>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_xf_syxf model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_xf_syxf();
