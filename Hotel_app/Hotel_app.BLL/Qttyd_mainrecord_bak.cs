...
{
	/// <summary>
	/// Qttyd_mainrecord_bak
	/// </summary>
	public partial class Qttyd_mainrecord_bak
	{
		private readonly Hotel_app.DAL.Qttyd_mainrecord_bak dal=new Hotel_app.DAL.Qttyd_mainrecord_bak();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Qttyd_mainrecord_bak GetModelByCache(int id)
		{
			
			string CacheKey = "Qttyd_mainrecord_bakModel-" + id;
			...
			return (Hotel_app.Model.Qttyd_mainrecord_bak)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qttyd_mainrecord_bak> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qttyd_mainrecord_bak> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Qttyd_mainrecord_bak> modelList = new List<Hotel_app.Model.Qttyd_mainrecord_bak>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Qttyd_mainrecord_bak model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Qttyd_mainrecord_bak();
