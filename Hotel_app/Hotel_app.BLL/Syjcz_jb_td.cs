...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Syjcz_jb_td dal=new Hotel_app.DAL.Syjcz_jb_td();
		public Syjcz_jb_td()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Syjcz_jb_td GetModelByCache(int id)
		{
			
			string CacheKey = "Syjcz_jb_tdModel-" + id;
			...
			return (Hotel_app.Model.Syjcz_jb_td)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_jb_td> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_jb_td> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Syjcz_jb_td> modelList = new List<Hotel_app.Model.Syjcz_jb_td>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Syjcz_jb_td model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Syjcz_jb_td();
