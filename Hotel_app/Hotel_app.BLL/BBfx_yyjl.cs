...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.BBfx_yyjl dal=new Hotel_app.DAL.BBfx_yyjl();
		public BBfx_yyjl()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.BBfx_yyjl GetModelByCache(int id)
		{
			
			string CacheKey = "BBfx_yyjlModel-" + id;
			...
			return (Hotel_app.Model.BBfx_yyjl)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BBfx_yyjl> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BBfx_yyjl> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.BBfx_yyjl> modelList = new List<Hotel_app.Model.BBfx_yyjl>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.BBfx_yyjl model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.BBfx_yyjl();
