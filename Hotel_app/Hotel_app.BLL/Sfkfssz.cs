...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Sfkfssz dal=new Hotel_app.DAL.Sfkfssz();
		public Sfkfssz()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Sfkfssz GetModelByCache(int id)
		{
			
			string CacheKey = "SfkfsszModel-" + id;
			...
			return (Hotel_app.Model.Sfkfssz)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Sfkfssz> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Sfkfssz> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Sfkfssz> modelList = new List<Hotel_app.Model.Sfkfssz>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Sfkfssz model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Sfkfssz();
