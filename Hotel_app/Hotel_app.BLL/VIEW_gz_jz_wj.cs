...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_gz_jz_wj dal=new Hotel_app.DAL.VIEW_gz_jz_wj();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_gz_jz_wj GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "VIEW_gz_jz_wjModel-" ;
			...
			return (Hotel_app.Model.VIEW_gz_jz_wj)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_gz_jz_wj> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_gz_jz_wj> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_gz_jz_wj> modelList = new List<Hotel_app.Model.VIEW_gz_jz_wj>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_gz_jz_wj model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_gz_jz_wj();
