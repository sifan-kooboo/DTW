...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Szw_temp_bak dal=new Hotel_app.DAL.Szw_temp_bak();
		public Szw_temp_bak()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Szw_temp_bak GetModelByCache(int id)
		{
			
			string CacheKey = "Szw_temp_bakModel-" + id;
			...
			return (Hotel_app.Model.Szw_temp_bak)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Szw_temp_bak> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Szw_temp_bak> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Szw_temp_bak> modelList = new List<Hotel_app.Model.Szw_temp_bak>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Szw_temp_bak model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Szw_temp_bak();
