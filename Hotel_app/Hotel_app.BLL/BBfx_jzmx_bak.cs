...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.BBfx_jzmx_bak dal=new Hotel_app.DAL.BBfx_jzmx_bak();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.BBfx_jzmx_bak GetModelByCache(int id)
		{
			
			string CacheKey = "BBfx_jzmx_bakModel-" + id;
			...
			return (Hotel_app.Model.BBfx_jzmx_bak)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BBfx_jzmx_bak> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BBfx_jzmx_bak> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.BBfx_jzmx_bak> modelList = new List<Hotel_app.Model.BBfx_jzmx_bak>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.BBfx_jzmx_bak model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.BBfx_jzmx_bak();
