...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.View_Qskzd dal=new Hotel_app.DAL.View_Qskzd();
		public View_Qskzd()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.View_Qskzd GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "View_QskzdModel-" ;
			...
			return (Hotel_app.Model.View_Qskzd)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_Qskzd> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_Qskzd> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.View_Qskzd> modelList = new List<Hotel_app.Model.View_Qskzd>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.View_Qskzd model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.View_Qskzd();
