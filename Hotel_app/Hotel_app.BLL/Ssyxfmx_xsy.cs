...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Ssyxfmx_xsy dal=new Hotel_app.DAL.Ssyxfmx_xsy();
		public Ssyxfmx_xsy()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Ssyxfmx_xsy GetModelByCache(int id)
		{
			...
			return (Hotel_app.Model.Ssyxfmx_xsy)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ssyxfmx_xsy> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ssyxfmx_xsy> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Ssyxfmx_xsy> modelList = new List<Hotel_app.Model.Ssyxfmx_xsy>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Ssyxfmx_xsy model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Ssyxfmx_xsy();
