...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Q_sfz_save dal=new Hotel_app.DAL.Q_sfz_save();
		public Q_sfz_save()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Q_sfz_save GetModelByCache(int id)
		{
			
			string CacheKey = "Q_sfz_saveModel-" + id;
			...
			return (Hotel_app.Model.Q_sfz_save)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Q_sfz_save> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Q_sfz_save> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Q_sfz_save> modelList = new List<Hotel_app.Model.Q_sfz_save>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Q_sfz_save model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Q_sfz_save();
