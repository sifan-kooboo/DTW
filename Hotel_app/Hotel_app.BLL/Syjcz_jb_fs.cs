...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Syjcz_jb_fs dal=new Hotel_app.DAL.Syjcz_jb_fs();
		public Syjcz_jb_fs()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Syjcz_jb_fs GetModelByCache(int id)
		{
			
			string CacheKey = "Syjcz_jb_fsModel-" + id;
			...
			return (Hotel_app.Model.Syjcz_jb_fs)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_jb_fs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_jb_fs> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Syjcz_jb_fs> modelList = new List<Hotel_app.Model.Syjcz_jb_fs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Syjcz_jb_fs model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Syjcz_jb_fs();
