...
{
	/// <summary>
	/// VIEW_S_jzmx_bak_jzzgz
	/// </summary>
	public partial class VIEW_S_jzmx_bak_jzzgz
	{
		private readonly Hotel_app.DAL.VIEW_S_jzmx_bak_jzzgz dal=new Hotel_app.DAL.VIEW_S_jzmx_bak_jzzgz();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz GetModelByCache(int id)
		{
			
			string CacheKey = "VIEW_S_jzmx_bak_jzzgzModel-" + id;
			...
			return (Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz> modelList = new List<Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_jzmx_bak_jzzgz();
					...
					if(dt.Rows[n]["jzbh_new"]!=null && dt.Rows[n]["jzbh_new"].ToString()!="")
					{
					model.jzbh_new=dt.Rows[n]["jzbh_new"].ToString();
					}
