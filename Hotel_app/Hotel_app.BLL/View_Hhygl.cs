...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.View_Hhygl dal=new Hotel_app.DAL.View_Hhygl();
		public View_Hhygl()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.View_Hhygl GetModelByCache(int id)
		{
			
			string CacheKey = "View_HhyglModel-" + id;
			...
			return (Hotel_app.Model.View_Hhygl)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_Hhygl> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_Hhygl> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.View_Hhygl> modelList = new List<Hotel_app.Model.View_Hhygl>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.View_Hhygl model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.View_Hhygl();
