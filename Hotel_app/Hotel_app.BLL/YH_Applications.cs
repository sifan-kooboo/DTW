...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.YH_Applications dal=new Hotel_app.DAL.YH_Applications();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.YH_Applications GetModelByCache(int ID)
		{
			
			string CacheKey = "YH_ApplicationsModel-" + ID;
			...
			return (Hotel_app.Model.YH_Applications)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.YH_Applications> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.YH_Applications> DataTableToList(DataTable dt)
		{
