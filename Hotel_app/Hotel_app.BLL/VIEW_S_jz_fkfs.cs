...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_S_jz_fkfs dal=new Hotel_app.DAL.VIEW_S_jz_fkfs();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_jz_fkfs GetModelByCache(int id)
		{
			
			string CacheKey = "VIEW_S_jz_fkfsModel-" + id;
			...
			return (Hotel_app.Model.VIEW_S_jz_fkfs)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jz_fkfs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jz_fkfs> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_jz_fkfs> modelList = new List<Hotel_app.Model.VIEW_S_jz_fkfs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_jz_fkfs model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_jz_fkfs();
