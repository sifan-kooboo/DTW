...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Szwmx dal=new Hotel_app.DAL.Szwmx();
		public Szwmx()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Szwmx GetModelByCache(int id)
		{
			
			string CacheKey = "SzwmxModel-" + id;
			...
			return (Hotel_app.Model.Szwmx)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Szwmx> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Szwmx> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Szwmx> modelList = new List<Hotel_app.Model.Szwmx>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Szwmx model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Szwmx();
