...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Qskyd_mainrecord_lskr dal=new Hotel_app.DAL.Qskyd_mainrecord_lskr();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Qskyd_mainrecord_lskr GetModelByCache(int id)
		{
			...
			return (Hotel_app.Model.Qskyd_mainrecord_lskr)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qskyd_mainrecord_lskr> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qskyd_mainrecord_lskr> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Qskyd_mainrecord_lskr> modelList = new List<Hotel_app.Model.Qskyd_mainrecord_lskr>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Qskyd_mainrecord_lskr model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Qskyd_mainrecord_lskr();
