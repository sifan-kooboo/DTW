...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Syjcz_jb dal=new Hotel_app.DAL.Syjcz_jb();
		public Syjcz_jb()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Syjcz_jb GetModelByCache(int id)
		{
			
			string CacheKey = "Syjcz_jbModel-" + id;
			...
			return (Hotel_app.Model.Syjcz_jb)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_jb> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_jb> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Syjcz_jb> modelList = new List<Hotel_app.Model.Syjcz_jb>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Syjcz_jb model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Syjcz_jb();
