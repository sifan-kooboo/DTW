...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.S_cy_zl dal=new Hotel_app.DAL.S_cy_zl();
		public S_cy_zl()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.S_cy_zl GetModelByCache(int id)
		{
			
			string CacheKey = "S_cy_zlModel-" + id;
			...
			return (Hotel_app.Model.S_cy_zl)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.S_cy_zl> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.S_cy_zl> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.S_cy_zl> modelList = new List<Hotel_app.Model.S_cy_zl>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.S_cy_zl model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.S_cy_zl();
