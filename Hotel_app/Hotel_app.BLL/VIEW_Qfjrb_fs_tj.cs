...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_Qfjrb_fs_tj dal=new Hotel_app.DAL.VIEW_Qfjrb_fs_tj();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_Qfjrb_fs_tj GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "VIEW_Qfjrb_fs_tjModel-" ;
			...
			return (Hotel_app.Model.VIEW_Qfjrb_fs_tj)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_Qfjrb_fs_tj> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_Qfjrb_fs_tj> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_Qfjrb_fs_tj> modelList = new List<Hotel_app.Model.VIEW_Qfjrb_fs_tj>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_Qfjrb_fs_tj model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_Qfjrb_fs_tj();
