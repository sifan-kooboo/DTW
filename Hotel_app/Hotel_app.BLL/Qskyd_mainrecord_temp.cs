...
{
	/// <summary>
	/// Qskyd_mainrecord_temp
	/// </summary>
	public partial class Qskyd_mainrecord_temp
	{
		private readonly Hotel_app.DAL.Qskyd_mainrecord_temp dal=new Hotel_app.DAL.Qskyd_mainrecord_temp();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Qskyd_mainrecord_temp GetModelByCache(int id)
		{
			
			string CacheKey = "Qskyd_mainrecord_tempModel-" + id;
			...
			return (Hotel_app.Model.Qskyd_mainrecord_temp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qskyd_mainrecord_temp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qskyd_mainrecord_temp> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Qskyd_mainrecord_temp> modelList = new List<Hotel_app.Model.Qskyd_mainrecord_temp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Qskyd_mainrecord_temp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Qskyd_mainrecord_temp();
