...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Syjcz_bak dal=new Hotel_app.DAL.Syjcz_bak();
		public Syjcz_bak()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Syjcz_bak GetModelByCache(int id)
		{
			
			string CacheKey = "Syjcz_bakModel-" + id;
			...
			return (Hotel_app.Model.Syjcz_bak)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_bak> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_bak> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Syjcz_bak> modelList = new List<Hotel_app.Model.Syjcz_bak>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Syjcz_bak model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Syjcz_bak();
