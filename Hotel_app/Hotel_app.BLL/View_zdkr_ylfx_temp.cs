...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.View_zdkr_ylfx_temp dal=new Hotel_app.DAL.View_zdkr_ylfx_temp();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.View_zdkr_ylfx_temp GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "View_zdkr_ylfx_tempModel-" ;
			...
			return (Hotel_app.Model.View_zdkr_ylfx_temp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_zdkr_ylfx_temp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_zdkr_ylfx_temp> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.View_zdkr_ylfx_temp> modelList = new List<Hotel_app.Model.View_zdkr_ylfx_temp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.View_zdkr_ylfx_temp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.View_zdkr_ylfx_temp();
					...
					if(dt.Rows[n]["Expr2"]!=null && dt.Rows[n]["Expr2"].ToString()!="")
					{
					model.Expr2=dt.Rows[n]["Expr2"].ToString();
					}
