...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.View_kc_notsh dal=new Hotel_app.DAL.View_kc_notsh();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.View_kc_notsh GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "View_kc_notshModel-" ;
			...
			return (Hotel_app.Model.View_kc_notsh)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_kc_notsh> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.View_kc_notsh> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.View_kc_notsh> modelList = new List<Hotel_app.Model.View_kc_notsh>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.View_kc_notsh model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.View_kc_notsh();
