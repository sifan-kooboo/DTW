...
{
	/// <summary>
	/// VIEW_S_jzmx_bak_gzzjz
	/// </summary>
	public partial class VIEW_S_jzmx_bak_gzzjz
	{
		private readonly Hotel_app.DAL.VIEW_S_jzmx_bak_gzzjz dal=new Hotel_app.DAL.VIEW_S_jzmx_bak_gzzjz();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz GetModelByCache(int id)
		{
			
			string CacheKey = "VIEW_S_jzmx_bak_gzzjzModel-" + id;
			...
			return (Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz> modelList = new List<Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_jzmx_bak_gzzjz();
