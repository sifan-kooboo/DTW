...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Syjcz_ls dal=new Hotel_app.DAL.Syjcz_ls();
		public Syjcz_ls()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Syjcz_ls GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "Syjcz_lsModel-" ;
			...
			return (Hotel_app.Model.Syjcz_ls)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_ls> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Syjcz_ls> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Syjcz_ls> modelList = new List<Hotel_app.Model.Syjcz_ls>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Syjcz_ls model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Syjcz_ls();
