...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.BQ_syxfmx_ls dal=new Hotel_app.DAL.BQ_syxfmx_ls();
		public BQ_syxfmx_ls()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.BQ_syxfmx_ls GetModelByCache(int id)
		{
			
			string CacheKey = "BQ_syxfmx_lsModel-" + id;
			...
			return (Hotel_app.Model.BQ_syxfmx_ls)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BQ_syxfmx_ls> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BQ_syxfmx_ls> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.BQ_syxfmx_ls> modelList = new List<Hotel_app.Model.BQ_syxfmx_ls>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.BQ_syxfmx_ls model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.BQ_syxfmx_ls();
