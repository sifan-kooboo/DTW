...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Xfkfs dal=new Hotel_app.DAL.Xfkfs();
		public Xfkfs()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Xfkfs GetModelByCache(int id)
		{
			
			string CacheKey = "XfkfsModel-" + id;
			...
			return (Hotel_app.Model.Xfkfs)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Xfkfs> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Xfkfs> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Xfkfs> modelList = new List<Hotel_app.Model.Xfkfs>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Xfkfs model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Xfkfs();
