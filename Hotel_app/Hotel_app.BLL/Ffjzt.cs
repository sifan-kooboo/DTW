...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Ffjzt dal=new Hotel_app.DAL.Ffjzt();
		public Ffjzt()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Ffjzt GetModelByCache(int id)
		{
			...
			return (Hotel_app.Model.Ffjzt)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ffjzt> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ffjzt> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Ffjzt> modelList = new List<Hotel_app.Model.Ffjzt>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Ffjzt model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Ffjzt();
