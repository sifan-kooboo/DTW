...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Hhyjf_df dal=new Hotel_app.DAL.Hhyjf_df();
		public Hhyjf_df()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Hhyjf_df GetModelByCache(int id)
		{
			...
			return (Hotel_app.Model.Hhyjf_df)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Hhyjf_df> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Hhyjf_df> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Hhyjf_df> modelList = new List<Hotel_app.Model.Hhyjf_df>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Hhyjf_df model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Hhyjf_df();
