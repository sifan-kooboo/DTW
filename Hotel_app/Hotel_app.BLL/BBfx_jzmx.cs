...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.BBfx_jzmx dal=new Hotel_app.DAL.BBfx_jzmx();
		public BBfx_jzmx()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.BBfx_jzmx GetModelByCache(int id)
		{
			
			string CacheKey = "BBfx_jzmxModel-" + id;
			...
			return (Hotel_app.Model.BBfx_jzmx)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BBfx_jzmx> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BBfx_jzmx> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.BBfx_jzmx> modelList = new List<Hotel_app.Model.BBfx_jzmx>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.BBfx_jzmx model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.BBfx_jzmx();
