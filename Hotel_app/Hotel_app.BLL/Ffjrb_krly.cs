...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Ffjrb_krly dal=new Hotel_app.DAL.Ffjrb_krly();
		public Ffjrb_krly()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Ffjrb_krly GetModelByCache(int id)
		{
			
			string CacheKey = "Ffjrb_krlyModel-" + id;
			...
			return (Hotel_app.Model.Ffjrb_krly)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ffjrb_krly> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ffjrb_krly> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Ffjrb_krly> modelList = new List<Hotel_app.Model.Ffjrb_krly>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Ffjrb_krly model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Ffjrb_krly();
