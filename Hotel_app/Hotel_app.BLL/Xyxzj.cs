...
namespace Hotel_app.BLL
{
	...
	/// Xyxzj
	/// </summary>
	public partial class Xyxzj
	{
		private readonly Hotel_app.DAL.Xyxzj dal=new Hotel_app.DAL.Xyxzj();
		public Xyxzj()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Xyxzj GetModelByCache(int id)
		{
			
			string CacheKey = "XyxzjModel-" + id;
			...
			return (Hotel_app.Model.Xyxzj)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Xyxzj> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Xyxzj> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Xyxzj> modelList = new List<Hotel_app.Model.Xyxzj>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Xyxzj model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Xyxzj();
