...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_S_jz_jzORgz dal=new Hotel_app.DAL.VIEW_S_jz_jzORgz();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_jz_jzORgz GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "VIEW_S_jz_jzORgzModel-" ;
			...
			return (Hotel_app.Model.VIEW_S_jz_jzORgz)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jz_jzORgz> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jz_jzORgz> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_jz_jzORgz> modelList = new List<Hotel_app.Model.VIEW_S_jz_jzORgz>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_jz_jzORgz model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_jz_jzORgz();
