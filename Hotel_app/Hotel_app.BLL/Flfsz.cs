...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Flfsz dal=new Hotel_app.DAL.Flfsz();
		public Flfsz()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(Hotel_app.Model.Flfsz model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Flfsz model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Flfsz GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Flfsz GetModelByCache(int id)
		{
			
			string CacheKey = "FlfszModel-" + id;
			...
			return (Hotel_app.Model.Flfsz)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Flfsz> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Flfsz> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Flfsz> modelList = new List<Hotel_app.Model.Flfsz>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Flfsz model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Flfsz();
