...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Szwmx_bak dal=new Hotel_app.DAL.Szwmx_bak();
		public Szwmx_bak()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Szwmx_bak GetModelByCache(int id)
		{
			
			string CacheKey = "Szwmx_bakModel-" + id;
			...
			return (Hotel_app.Model.Szwmx_bak)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Szwmx_bak> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Szwmx_bak> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Szwmx_bak> modelList = new List<Hotel_app.Model.Szwmx_bak>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Szwmx_bak model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Szwmx_bak();
