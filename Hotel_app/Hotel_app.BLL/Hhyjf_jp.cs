...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Hhyjf_jp dal=new Hotel_app.DAL.Hhyjf_jp();
		public Hhyjf_jp()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(Hotel_app.Model.Hhyjf_jp model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Hhyjf_jp model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Hhyjf_jp GetModel(int ID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Hhyjf_jp GetModelByCache(int ID)
		{
			...
			return (Hotel_app.Model.Hhyjf_jp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Hhyjf_jp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Hhyjf_jp> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Hhyjf_jp> modelList = new List<Hotel_app.Model.Hhyjf_jp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Hhyjf_jp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Hhyjf_jp();
