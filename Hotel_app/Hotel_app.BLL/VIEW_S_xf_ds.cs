...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_S_xf_ds dal=new Hotel_app.DAL.VIEW_S_xf_ds();
		public VIEW_S_xf_ds()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_xf_ds GetModelByCache(int id)
		{
			
			string CacheKey = "VIEW_S_xf_dsModel-" + id;
			...
			return (Hotel_app.Model.VIEW_S_xf_ds)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_xf_ds> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_xf_ds> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_xf_ds> modelList = new List<Hotel_app.Model.VIEW_S_xf_ds>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_xf_ds model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_xf_ds();
