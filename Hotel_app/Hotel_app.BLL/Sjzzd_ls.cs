...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Sjzzd_ls dal=new Hotel_app.DAL.Sjzzd_ls();
		public Sjzzd_ls()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Sjzzd_ls GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "Sjzzd_lsModel-" ;
			...
			return (Hotel_app.Model.Sjzzd_ls)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Sjzzd_ls> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Sjzzd_ls> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Sjzzd_ls> modelList = new List<Hotel_app.Model.Sjzzd_ls>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Sjzzd_ls model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Sjzzd_ls();
