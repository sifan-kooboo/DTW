...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.BQ_syxfmx_hy_ls dal=new Hotel_app.DAL.BQ_syxfmx_hy_ls();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.BQ_syxfmx_hy_ls GetModelByCache(int id)
		{
			
			string CacheKey = "BQ_syxfmx_hy_lsModel-" + id;
			...
			return (Hotel_app.Model.BQ_syxfmx_hy_ls)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BQ_syxfmx_hy_ls> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.BQ_syxfmx_hy_ls> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.BQ_syxfmx_hy_ls> modelList = new List<Hotel_app.Model.BQ_syxfmx_hy_ls>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.BQ_syxfmx_hy_ls model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.BQ_syxfmx_hy_ls();
