...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_S_jz_jzORgz_zd dal=new Hotel_app.DAL.VIEW_S_jz_jzORgz_zd();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_jz_jzORgz_zd GetModelByCache(int id)
		{
			
			string CacheKey = "VIEW_S_jz_jzORgz_zdModel-" + id;
			...
			return (Hotel_app.Model.VIEW_S_jz_jzORgz_zd)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jz_jzORgz_zd> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_jz_jzORgz_zd> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_jz_jzORgz_zd> modelList = new List<Hotel_app.Model.VIEW_S_jz_jzORgz_zd>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_jz_jzORgz_zd model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_jz_jzORgz_zd();
