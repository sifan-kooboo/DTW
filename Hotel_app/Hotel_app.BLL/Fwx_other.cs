...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Fwx_other dal=new Hotel_app.DAL.Fwx_other();
		public Fwx_other()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Fwx_other GetModelByCache(int id)
		{
			...
			return (Hotel_app.Model.Fwx_other)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Fwx_other> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Fwx_other> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Fwx_other> modelList = new List<Hotel_app.Model.Fwx_other>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Fwx_other model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Fwx_other();
