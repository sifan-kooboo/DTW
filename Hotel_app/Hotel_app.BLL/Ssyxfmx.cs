...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Ssyxfmx dal=new Hotel_app.DAL.Ssyxfmx();
		public Ssyxfmx()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(Hotel_app.Model.Ssyxfmx model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Hotel_app.Model.Ssyxfmx model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Hotel_app.Model.Ssyxfmx GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Ssyxfmx GetModelByCache(int id)
		{
			...
			return (Hotel_app.Model.Ssyxfmx)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ssyxfmx> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Ssyxfmx> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Ssyxfmx> modelList = new List<Hotel_app.Model.Ssyxfmx>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Ssyxfmx model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Ssyxfmx();
