...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_syxf_kc_temp dal=new Hotel_app.DAL.VIEW_syxf_kc_temp();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_syxf_kc_temp GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "VIEW_syxf_kc_tempModel-" ;
			...
			return (Hotel_app.Model.VIEW_syxf_kc_temp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_syxf_kc_temp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_syxf_kc_temp> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_syxf_kc_temp> modelList = new List<Hotel_app.Model.VIEW_syxf_kc_temp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_syxf_kc_temp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_syxf_kc_temp();
