...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Hhyjf_xfjl dal=new Hotel_app.DAL.Hhyjf_xfjl();
		public Hhyjf_xfjl()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Hhyjf_xfjl GetModelByCache(int id)
		{
			...
			return (Hotel_app.Model.Hhyjf_xfjl)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Hhyjf_xfjl> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Hhyjf_xfjl> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Hhyjf_xfjl> modelList = new List<Hotel_app.Model.Hhyjf_xfjl>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Hhyjf_xfjl model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Hhyjf_xfjl();
