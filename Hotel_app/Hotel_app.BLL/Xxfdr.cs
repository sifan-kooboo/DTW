...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Xxfdr dal=new Hotel_app.DAL.Xxfdr();
		public Xxfdr()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Xxfdr GetModelByCache(int id)
		{
			
			string CacheKey = "XxfdrModel-" + id;
			...
			return (Hotel_app.Model.Xxfdr)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Xxfdr> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Xxfdr> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Xxfdr> modelList = new List<Hotel_app.Model.Xxfdr>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Xxfdr model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Xxfdr();
