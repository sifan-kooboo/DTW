...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Q_ff_xyxf dal=new Hotel_app.DAL.Q_ff_xyxf();
		public Q_ff_xyxf()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Q_ff_xyxf GetModelByCache(int id)
		{
			
			string CacheKey = "Q_ff_xyxfModel-" + id;
			...
			return (Hotel_app.Model.Q_ff_xyxf)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Q_ff_xyxf> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Q_ff_xyxf> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Q_ff_xyxf> modelList = new List<Hotel_app.Model.Q_ff_xyxf>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Q_ff_xyxf model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Q_ff_xyxf();
