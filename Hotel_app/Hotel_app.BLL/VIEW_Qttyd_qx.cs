...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_Qttyd_qx dal=new Hotel_app.DAL.VIEW_Qttyd_qx();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_Qttyd_qx GetModelByCache(int id)
		{
			
			string CacheKey = "VIEW_Qttyd_qxModel-" + id;
			...
			return (Hotel_app.Model.VIEW_Qttyd_qx)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_Qttyd_qx> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_Qttyd_qx> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_Qttyd_qx> modelList = new List<Hotel_app.Model.VIEW_Qttyd_qx>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_Qttyd_qx model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_Qttyd_qx();
