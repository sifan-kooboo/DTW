...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Qtsjy dal=new Hotel_app.DAL.Qtsjy();
		public Qtsjy()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Qtsjy GetModelByCache(int id)
		{
			
			string CacheKey = "QtsjyModel-" + id;
			...
			return (Hotel_app.Model.Qtsjy)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qtsjy> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qtsjy> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Qtsjy> modelList = new List<Hotel_app.Model.Qtsjy>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Qtsjy model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Qtsjy();
					...
					if(dt.Rows[n]["tsrx"]!=null && dt.Rows[n]["tsrx"].ToString()!="")
					{
					model.tsrx=dt.Rows[n]["tsrx"].ToString();
					}
					if(dt.Rows[n]["tsnr"]!=null && dt.Rows[n]["tsnr"].ToString()!="")
					{
					model.tsnr=dt.Rows[n]["tsnr"].ToString();
					}
					if(dt.Rows[n]["tssj"]!=null && dt.Rows[n]["tssj"].ToString()!="")
					{
						model.tssj=DateTime.Parse(dt.Rows[n]["tssj"].ToString());
					}
					if(dt.Rows[n]["czy"]!=null && dt.Rows[n]["czy"].ToString()!="")
					{
					model.czy=dt.Rows[n]["czy"].ToString();
					}
					if(dt.Rows[n]["clbm"]!=null && dt.Rows[n]["clbm"].ToString()!="")
					{
					model.clbm=dt.Rows[n]["clbm"].ToString();
					}
					if(dt.Rows[n]["clnr"]!=null && dt.Rows[n]["clnr"].ToString()!="")
					{
					model.clnr=dt.Rows[n]["clnr"].ToString();
					}
					if(dt.Rows[n]["clsj"]!=null && dt.Rows[n]["clsj"].ToString()!="")
					{
						model.clsj=DateTime.Parse(dt.Rows[n]["clsj"].ToString());
					}
					if(dt.Rows[n]["cly"]!=null && dt.Rows[n]["cly"].ToString()!="")
					{
					model.cly=dt.Rows[n]["cly"].ToString();
					}
