...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.VIEW_S_gz_ye dal=new Hotel_app.DAL.VIEW_S_gz_ye();
		public VIEW_S_gz_ye()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.VIEW_S_gz_ye GetModelByCache()
		{
			//该表无主键信息，请自定义主键/条件字段
			string CacheKey = "VIEW_S_gz_yeModel-" ;
			...
			return (Hotel_app.Model.VIEW_S_gz_ye)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_gz_ye> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.VIEW_S_gz_ye> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.VIEW_S_gz_ye> modelList = new List<Hotel_app.Model.VIEW_S_gz_ye>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.VIEW_S_gz_ye model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.VIEW_S_gz_ye();
