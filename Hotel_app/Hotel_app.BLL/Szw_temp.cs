...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Szw_temp dal=new Hotel_app.DAL.Szw_temp();
		public Szw_temp()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Szw_temp GetModelByCache(int id)
		{
			
			string CacheKey = "Szw_tempModel-" + id;
			...
			return (Hotel_app.Model.Szw_temp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Szw_temp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Szw_temp> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Szw_temp> modelList = new List<Hotel_app.Model.Szw_temp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Szw_temp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Szw_temp();
