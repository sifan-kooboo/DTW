...
namespace Hotel_app.BLL
{
	...
	{
		private readonly Hotel_app.DAL.Qkrxh dal=new Hotel_app.DAL.Qkrxh();
		public Qkrxh()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Hotel_app.Model.Qkrxh GetModelByCache(int id)
		{
			
			string CacheKey = "QkrxhModel-" + id;
			...
			return (Hotel_app.Model.Qkrxh)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qkrxh> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Hotel_app.Model.Qkrxh> DataTableToList(DataTable dt)
		{
			List<Hotel_app.Model.Qkrxh> modelList = new List<Hotel_app.Model.Qkrxh>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Hotel_app.Model.Qkrxh model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Hotel_app.Model.Qkrxh();
					...
					if(dt.Rows[n]["krxh"]!=null && dt.Rows[n]["krxh"].ToString()!="")
					{
					model.krxh=dt.Rows[n]["krxh"].ToString();
					}
