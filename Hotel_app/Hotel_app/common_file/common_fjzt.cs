...
namespace Hotel_app.common_file
{
    public static class common_fjzt
    {
        ...
        //public static bool sh_ds =true;//夜审后是否出现打扫
        public static bool sh_ds = bool.Parse(Common_initalSystem.ReadNameValueSectionValue("qyinfo", "sh_ds"));// false;//对应Qcounter里的shlz这个字段
        ...
        {
            bool shts = false;
            //Model.Flfsz M_flfsz = new Hotel_service.Model.Flfsz();
        ...
        {
            bool shvip = false;
            //Model.Qskyd_mainrecord M_Qskyd_mainrecord = new Hotel_service.Model.Qskyd_mainrecord();
            BLL.Qskyd_mainrecord B_Qskyd_mainrecord = new Hotel_app.BLL.Qskyd_mainrecord();
