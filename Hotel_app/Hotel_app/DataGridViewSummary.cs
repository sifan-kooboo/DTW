...
namespace Hotel_app
{
    ...
    public partial class DataGridViewSummary : DataGridView, ISupportInitialize
    {
        ...
        private void hScrollBar_Scroll(object sender, ScrollEventArgs e)
        {
            ...
            if (position < Columns.Count)
            {
                if (Columns[position].Visible)  //判断这一行是否可见，没有会产生BUG
                {
                    //FirstDisplayedScrollingRowIndex = position;
	...
	//新增加的功能：2011-12-02
        ...
        #endregion
        #region 行号
      public void SetHeaderValue(DataGridView dgv)
        {
            int rowHeaderNum = 1;
            foreach (DataGridViewRow r in dgv.Rows)
            {
                ...
                //r.HeaderCell.Style.Padding.Left = 2;
               // r.HeaderCell.Style.Padding.Right = 2;
