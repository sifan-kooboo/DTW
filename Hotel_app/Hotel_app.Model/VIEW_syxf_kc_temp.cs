...
{
	/// <summary>
	/// VIEW_syxf_kc_temp:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class VIEW_syxf_kc_temp
	{
		...
		private string _lsbh_jk;
		private string _czsj_jk;
		...
		private decimal _jjje;
		private decimal _xfje;
		private string _yh;
		private decimal _sjxfje;
