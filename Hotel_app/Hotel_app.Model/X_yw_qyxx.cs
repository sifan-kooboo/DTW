...
{
	/// <summary>
	/// X_yw_qyxx:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class X_yw_qyxx
	{
		...
		private DateTime _xtyysj;
		private string _hyxs;
		private string _lx;
		private string _qymcyw;
		private string _wz;
		private string _qydzyw;
