...
{
	/// <summary>
	/// View_Qskzd:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class View_Qskzd
	{
		...
		private decimal _lzfs;
		private decimal _fjjg;
