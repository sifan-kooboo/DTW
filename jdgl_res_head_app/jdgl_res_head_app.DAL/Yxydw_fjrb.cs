...
namespace jdgl_res_head_app.DAL
{
	...
	public partial class Yxydw_fjrb
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_app.Model.Yxydw_fjrb model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Yxydw_fjrb(");
			strSql.Append("yydh,qymc,xyh,xydw,fjrb,fjrb_code,sjjg,is_top,is_select)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_app.Model.Yxydw_fjrb model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_app.Model.Yxydw_fjrb GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,xyh,xydw,fjrb,fjrb_code,sjjg,is_top,is_select from Yxydw_fjrb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_app.Model.Yxydw_fjrb model=new jdgl_res_head_app.Model.Yxydw_fjrb();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,xyh,xydw,fjrb,fjrb_code,sjjg,is_top,is_select ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,xyh,xydw,fjrb,fjrb_code,sjjg,is_top,is_select ");
			strSql.Append(" FROM Yxydw_fjrb ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
