...
namespace jdgl_res_head_app.DAL
{
	...
	public partial class Qyqskyd_ydzxqr
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qyqskyd_ydzxqr"); 
		}
		...
		public int Add(jdgl_res_head_app.Model.Qyqskyd_ydzxqr model)
		{
			...
			strSql.Append("lsbh,qrzt,qrsj,qryy,czy,shsc,scsj,fjrb,qymc,yydh)");
		...
		public jdgl_res_head_app.Model.Qyqskyd_ydzxqr GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,lsbh,qrzt,qrsj,qryy,czy,shsc,scsj,fjrb,qymc,yydh from Qyqskyd_ydzxqr ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_app.Model.Qyqskyd_ydzxqr model=new jdgl_res_head_app.Model.Qyqskyd_ydzxqr();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,lsbh,qrzt,qrsj,qryy,czy,shsc,scsj,fjrb,qymc,yydh ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,lsbh,qrzt,qrsj,qryy,czy,shsc,scsj,fjrb,qymc,yydh ");
			strSql.Append(" FROM Qyqskyd_ydzxqr ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
