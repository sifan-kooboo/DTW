...
namespace jdgl_res_head_app.DAL
{
	...
	public partial class Ffjrb
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_app.Model.Ffjrb model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_app.Model.Ffjrb model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_app.Model.Ffjrb GetModel(int id)
		{
			...
			jdgl_res_head_app.Model.Ffjrb model=new jdgl_res_head_app.Model.Ffjrb();
