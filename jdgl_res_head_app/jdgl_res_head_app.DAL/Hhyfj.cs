...
namespace jdgl_res_head_app.DAL
{
	...
	public partial class Hhyfj
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_app.Model.Hhyfj model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_app.Model.Hhyfj model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_app.Model.Hhyfj GetModel(int id)
		{
			...
			jdgl_res_head_app.Model.Hhyfj model=new jdgl_res_head_app.Model.Hhyfj();
