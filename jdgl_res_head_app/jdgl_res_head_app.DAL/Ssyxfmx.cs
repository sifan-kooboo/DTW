...
namespace jdgl_res_head_app.DAL
{
	...
	public partial class Ssyxfmx
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Ssyxfmx"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Ssyxfmx");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_app.Model.Ssyxfmx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ssyxfmx(");
			strSql.Append("yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_app.Model.Ssyxfmx model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ssyxfmx set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ssyxfmx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_app.Model.Ssyxfmx GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh from Ssyxfmx ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_app.Model.Ssyxfmx model=new jdgl_res_head_app.Model.Ssyxfmx();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh ");
			strSql.Append(" FROM Ssyxfmx ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,is_top,is_select,id_app,jzbh,lsbh,krxm,fjrb,fjbh,sktt,xfrq,xfsj,czy,xfdr,xfrb,xfxm,xfbz,xfzy,jjje,xfje,yh,sjxfje,xfsl,shsc,czy_bc,is_visible,mxbh ");
			strSql.Append(" FROM Ssyxfmx ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Ssyxfmx T ");
