...
{
	/// <summary>
	/// 数据访问类:Qttyd_mainrecord
	/// </summary>
	public partial class Qttyd_mainrecord
	{
		public Qttyd_mainrecord()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qttyd_mainrecord"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qttyd_mainrecord");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_app.Model.Qttyd_mainrecord model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_app.Model.Qttyd_mainrecord model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qttyd_mainrecord ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_app.Model.Qttyd_mainrecord GetModel(int id)
		{
			...
			jdgl_res_head_app.Model.Qttyd_mainrecord model=new jdgl_res_head_app.Model.Qttyd_mainrecord();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,lsbh,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,ddly ");
			strSql.Append(" FROM Qttyd_mainrecord ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,lsbh,ddbh,krxm,krbh,yddj,sktt,krgj,krdz,krly,xyh,xydw,xsy,krdh,krsj,krEmail,ydrxm,ddsj,ddyy,lzts,lksj,qtyq,ddrx,ddwz,zyzt,czy,cznr,czsj,is_top,is_select,ffshys,shsc,sdcz,syzd,tsyq,ddly ");
			strSql.Append(" FROM Qttyd_mainrecord ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qttyd_mainrecord T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Qttyd_mainrecord";
