...
namespace jdgl_res_head_app.DAL
{
	...
	public partial class BSzhrbbfl
	{
		...
		public int Add(jdgl_res_head_app.Model.BSzhrbbfl model)
		{
			...
			strSql.Append("yydh,qymc,bbrq,zfs,zyye,zfh,czfs,pjczl,pjfj,jcb,wjds,gztj,jztj,sztj,yjds,ljwj,ljyf,ljgz,ljjz,shsc)");
		...
		public jdgl_res_head_app.Model.BSzhrbbfl GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,bbrq,zfs,zyye,zfh,czfs,pjczl,pjfj,jcb,wjds,gztj,jztj,sztj,yjds,ljwj,ljyf,ljgz,ljjz,shsc from BSzhrbbfl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_app.Model.BSzhrbbfl model=new jdgl_res_head_app.Model.BSzhrbbfl();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,bbrq,zfs,zyye,zfh,czfs,pjczl,pjfj,jcb,wjds,gztj,jztj,sztj,yjds,ljwj,ljyf,ljgz,ljjz,shsc ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,bbrq,zfs,zyye,zfh,czfs,pjczl,pjfj,jcb,wjds,gztj,jztj,sztj,yjds,ljwj,ljyf,ljgz,ljjz,shsc ");
			strSql.Append(" FROM BSzhrbbfl ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
