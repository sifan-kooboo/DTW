...
namespace jdgl_res_head_app.BLL
{
	...
	{
		private readonly jdgl_res_head_app.DAL.Hhygl dal=new jdgl_res_head_app.DAL.Hhygl();
		public Hhygl()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_app.Model.Hhygl GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_app.Model.Hhygl)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Hhygl> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Hhygl> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_app.Model.Hhygl> modelList = new List<jdgl_res_head_app.Model.Hhygl>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_app.Model.Hhygl model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_app.Model.Hhygl();
