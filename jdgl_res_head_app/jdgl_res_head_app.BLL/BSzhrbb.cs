...
namespace jdgl_res_head_app.BLL
{
	...
	{
		private readonly jdgl_res_head_app.DAL.BSzhrbb dal=new jdgl_res_head_app.DAL.BSzhrbb();
		public BSzhrbb()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_app.Model.BSzhrbb GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_app.Model.BSzhrbb)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.BSzhrbb> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.BSzhrbb> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_app.Model.BSzhrbb> modelList = new List<jdgl_res_head_app.Model.BSzhrbb>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_app.Model.BSzhrbb model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_app.Model.BSzhrbb();
