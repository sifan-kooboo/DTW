...
namespace jdgl_res_head_app.BLL
{
	...
	{
		private readonly jdgl_res_head_app.DAL.Qskyd_fjrb_lskr dal=new jdgl_res_head_app.DAL.Qskyd_fjrb_lskr();
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(jdgl_res_head_app.Model.Qskyd_fjrb_lskr model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_app.Model.Qskyd_fjrb_lskr model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_app.Model.Qskyd_fjrb_lskr GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_app.Model.Qskyd_fjrb_lskr GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_app.Model.Qskyd_fjrb_lskr)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Qskyd_fjrb_lskr> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Qskyd_fjrb_lskr> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_app.Model.Qskyd_fjrb_lskr> modelList = new List<jdgl_res_head_app.Model.Qskyd_fjrb_lskr>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_app.Model.Qskyd_fjrb_lskr model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_app.Model.Qskyd_fjrb_lskr();
