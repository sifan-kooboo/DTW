...
namespace jdgl_res_head_app.BLL
{
	...
	{
		private readonly jdgl_res_head_app.DAL.Hhyjf_df dal=new jdgl_res_head_app.DAL.Hhyjf_df();
		public Hhyjf_df()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(jdgl_res_head_app.Model.Hhyjf_df model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_app.Model.Hhyjf_df model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_app.Model.Hhyjf_df GetModel(int id)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_app.Model.Hhyjf_df GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_app.Model.Hhyjf_df)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Hhyjf_df> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Hhyjf_df> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_app.Model.Hhyjf_df> modelList = new List<jdgl_res_head_app.Model.Hhyjf_df>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_app.Model.Hhyjf_df model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_app.Model.Hhyjf_df();
