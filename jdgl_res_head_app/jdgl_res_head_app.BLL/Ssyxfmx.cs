...
namespace jdgl_res_head_app.BLL
{
	...
	{
		private readonly jdgl_res_head_app.DAL.Ssyxfmx dal=new jdgl_res_head_app.DAL.Ssyxfmx();
		public Ssyxfmx()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_app.Model.Ssyxfmx GetModelByCache(int id)
		{
			
			string CacheKey = "SsyxfmxModel-" + id;
			...
			return (jdgl_res_head_app.Model.Ssyxfmx)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Ssyxfmx> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Ssyxfmx> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_app.Model.Ssyxfmx> modelList = new List<jdgl_res_head_app.Model.Ssyxfmx>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_app.Model.Ssyxfmx model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_app.Model.Ssyxfmx();
