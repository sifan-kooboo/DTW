...
namespace jdgl_res_head_app.BLL
{
	...
	{
		private readonly jdgl_res_head_app.DAL.Qttyd_mainrecord dal=new jdgl_res_head_app.DAL.Qttyd_mainrecord();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_app.Model.Qttyd_mainrecord GetModelByCache(int id)
		{
			
			string CacheKey = "Qttyd_mainrecordModel-" + id;
			...
			return (jdgl_res_head_app.Model.Qttyd_mainrecord)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Qttyd_mainrecord> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_app.Model.Qttyd_mainrecord> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_app.Model.Qttyd_mainrecord> modelList = new List<jdgl_res_head_app.Model.Qttyd_mainrecord>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_app.Model.Qttyd_mainrecord model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_app.Model.Qttyd_mainrecord();
