...
namespace jdgl_res_head_service.DAL
{
	...
	public partial class Fwx_other
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Fwx_other"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Fwx_other");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_service.Model.Fwx_other model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Fwx_other(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_service.Model.Fwx_other model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Fwx_other set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Fwx_other ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_service.Model.Fwx_other GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lsbh,fjrb,fjbh,ddsj,lksj,bz,zyzt,czsj,cznr,czy,is_top,is_select,shsc from Fwx_other ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Fwx_other model=new jdgl_res_head_service.Model.Fwx_other();
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Fwx_other T ");
