...
namespace jdgl_res_head_service.DAL
{
	...
	public partial class Yxydw_fjrb
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Yxydw_fjrb"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Yxydw_fjrb");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_service.Model.Yxydw_fjrb model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Yxydw_fjrb(");
			strSql.Append("yydh,qymc,xyh,xydw,fjrb,fjrb_code,sjjg,is_top,is_select,is_xz)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_service.Model.Yxydw_fjrb model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Yxydw_fjrb set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Yxydw_fjrb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_service.Model.Yxydw_fjrb GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,xyh,xydw,fjrb,fjrb_code,sjjg,is_top,is_select,is_xz from Yxydw_fjrb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Yxydw_fjrb model=new jdgl_res_head_service.Model.Yxydw_fjrb();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["is_xz"]!=null && ds.Tables[0].Rows[0]["is_xz"].ToString()!="")
				{
					if((ds.Tables[0].Rows[0]["is_xz"].ToString()=="1")||(ds.Tables[0].Rows[0]["is_xz"].ToString().ToLower()=="true"))
					{
						model.is_xz=true;
					}
					else
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,xyh,xydw,fjrb,fjrb_code,sjjg,is_top,is_select,is_xz ");
			strSql.Append(" FROM Yxydw_fjrb ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,xyh,xydw,fjrb,fjrb_code,sjjg,is_top,is_select,is_xz ");
			strSql.Append(" FROM Yxydw_fjrb ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Yxydw_fjrb T ");
