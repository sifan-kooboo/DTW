...
{
	/// <summary>
	/// 数据访问类:Fwx_other_temp
	/// </summary>
	public partial class Fwx_other_temp
	{
		public Fwx_other_temp()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Fwx_other_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Fwx_other_temp");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_service.Model.Fwx_other_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Fwx_other_temp(");
			strSql.Append("yydh,qymc,lsbh,fjrb,fjbh,ddsj,lksj,bz,zyzt,czsj,cznr,czy,is_top,is_select,shsc)");
			...
			parameters[8].Value = model.zyzt;
			parameters[9].Value = model.czsj;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_service.Model.Fwx_other_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Fwx_other_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Fwx_other_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_service.Model.Fwx_other_temp GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lsbh,fjrb,fjbh,ddsj,lksj,bz,zyzt,czsj,cznr,czy,is_top,is_select,shsc from Fwx_other_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Fwx_other_temp model=new jdgl_res_head_service.Model.Fwx_other_temp();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,lsbh,fjrb,fjbh,ddsj,lksj,bz,zyzt,czsj,cznr,czy,is_top,is_select,shsc ");
			strSql.Append(" FROM Fwx_other_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,lsbh,fjrb,fjbh,ddsj,lksj,bz,zyzt,czsj,cznr,czy,is_top,is_select,shsc ");
			strSql.Append(" FROM Fwx_other_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Fwx_other_temp T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Fwx_other_temp";
