...
namespace jdgl_res_head_service.DAL
{
	...
	public partial class Hhyfj
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Hhyfj"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Hhyfj");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_service.Model.Hhyfj model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Hhyfj(");
			strSql.Append("yydh,qymc,hyrx,fjrb,hyfj,bz,shsc,is_top,is_select)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@hyfj", SqlDbType.Decimal,9),
			...
			parameters[4].Value = model.hyfj;
			parameters[5].Value = model.bz;
			parameters[6].Value = model.shsc;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_service.Model.Hhyfj model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Hhyfj set ");
			strSql.Append("yydh=@yydh,");
			strSql.Append("qymc=@qymc,");
			strSql.Append("hyrx=@hyrx,");
			strSql.Append("fjrb=@fjrb,");
			strSql.Append("hyfj=@hyfj,");
			strSql.Append("bz=@bz,");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Hhyfj ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_service.Model.Hhyfj GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,hyrx,fjrb,hyfj,bz,shsc,is_top,is_select from Hhyfj ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Hhyfj model=new jdgl_res_head_service.Model.Hhyfj();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["hyfj"]!=null && ds.Tables[0].Rows[0]["hyfj"].ToString()!="")
				{
					model.hyfj=decimal.Parse(ds.Tables[0].Rows[0]["hyfj"].ToString());
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,hyrx,fjrb,hyfj,bz,shsc,is_top,is_select ");
			strSql.Append(" FROM Hhyfj ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,hyrx,fjrb,hyfj,bz,shsc,is_top,is_select ");
			strSql.Append(" FROM Hhyfj ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Hhyfj T ");
