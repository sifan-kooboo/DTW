...
namespace jdgl_res_head_service.DAL
{
	...
	public partial class Yxydw
	{
		...
		public jdgl_res_head_service.Model.Yxydw GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,krly,yydh,qymc,xyrx,krgj,pq,xyh,xyh_inner,rx,xydw,zjm,nxr,krdh,krcz,krEmail,krdz,xsy,shsc,bz,lzfs,fkje,xfje,clsj,xzxg,is_top,is_select,shsh,sign_image from Yxydw ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Yxydw model=new jdgl_res_head_service.Model.Yxydw();
