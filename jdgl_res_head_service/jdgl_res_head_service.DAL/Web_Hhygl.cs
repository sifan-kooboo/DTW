...
namespace jdgl_res_head_service.DAL
{
	...
	/// 数据访问类:Web_Hhygl
	/// </summary>
	public partial class Web_Hhygl
	{
		public Web_Hhygl()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_service.Model.Web_Hhygl model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_service.Model.Web_Hhygl model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_service.Model.Web_Hhygl GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,hyrx,hykh,hykh_bz,krxm,krgj,krmz,yxzj,zjhm,krsr,krxb,krdh,krsj,krEmail,krdz,krzy,krdw,qzrx,qzhm,zjyxq,tlyxq,tjrq,lzka,bz,djsj,hyjf,dfjf,shsc,scsj,xgsj,shxg,shqr,is_top,is_select,fkje,parent_hykh,hymm,xsy,czy from Web_Hhygl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Web_Hhygl model=new jdgl_res_head_service.Model.Web_Hhygl();
