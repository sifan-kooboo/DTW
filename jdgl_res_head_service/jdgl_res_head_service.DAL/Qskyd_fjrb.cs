...
namespace jdgl_res_head_service.DAL
{
	...
	public partial class Qskyd_fjrb
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qskyd_fjrb"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qskyd_fjrb");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_service.Model.Qskyd_fjrb model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Qskyd_fjrb(");
			strSql.Append("yydh,qymc,lsbh,krxm,sktt,yddj,fjrb,fjbh,ddsj,lksj,lzfs,shqh,fjjg,sjfjjg,yh,yhbl,bz,is_top,is_select,shsc,czy,czsj,cznr,sdcz,fjbm,jcje,isok)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_service.Model.Qskyd_fjrb model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qskyd_fjrb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_service.Model.Qskyd_fjrb GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lsbh,krxm,sktt,yddj,fjrb,fjbh,ddsj,lksj,lzfs,shqh,fjjg,sjfjjg,yh,yhbl,bz,is_top,is_select,shsc,czy,czsj,cznr,sdcz,fjbm,jcje,isok from Qskyd_fjrb ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Qskyd_fjrb model=new jdgl_res_head_service.Model.Qskyd_fjrb();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,lsbh,krxm,sktt,yddj,fjrb,fjbh,ddsj,lksj,lzfs,shqh,fjjg,sjfjjg,yh,yhbl,bz,is_top,is_select,shsc,czy,czsj,cznr,sdcz,fjbm,jcje,isok ");
			strSql.Append(" FROM Qskyd_fjrb ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,lsbh,krxm,sktt,yddj,fjrb,fjbh,ddsj,lksj,lzfs,shqh,fjjg,sjfjjg,yh,yhbl,bz,is_top,is_select,shsc,czy,czsj,cznr,sdcz,fjbm,jcje,isok ");
			strSql.Append(" FROM Qskyd_fjrb ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qskyd_fjrb T ");
