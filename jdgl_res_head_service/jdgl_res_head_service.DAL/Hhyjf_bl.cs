...
namespace jdgl_res_head_service.DAL
{
	...
	public partial class Hhyjf_bl
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Hhyjf_bl"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Hhyjf_bl");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_service.Model.Hhyjf_bl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Hhyjf_bl(");
			strSql.Append("yydh,qymc,krly,hyrx,jfbl,hyjfrx,is_top,is_select)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@jfbl", SqlDbType.Decimal,9),
			...
			parameters[4].Value = model.jfbl;
			parameters[5].Value = model.hyjfrx;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_service.Model.Hhyjf_bl model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Hhyjf_bl set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Hhyjf_bl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_service.Model.Hhyjf_bl GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,krly,hyrx,jfbl,hyjfrx,is_top,is_select from Hhyjf_bl ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Hhyjf_bl model=new jdgl_res_head_service.Model.Hhyjf_bl();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["jfbl"]!=null && ds.Tables[0].Rows[0]["jfbl"].ToString()!="")
				{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,krly,hyrx,jfbl,hyjfrx,is_top,is_select ");
			strSql.Append(" FROM Hhyjf_bl ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,krly,hyrx,jfbl,hyjfrx,is_top,is_select ");
			strSql.Append(" FROM Hhyjf_bl ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Hhyjf_bl T ");
