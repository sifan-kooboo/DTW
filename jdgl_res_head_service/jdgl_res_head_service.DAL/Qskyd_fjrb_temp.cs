...
{
	/// <summary>
	/// 数据访问类:Qskyd_fjrb_temp
	/// </summary>
	public partial class Qskyd_fjrb_temp
	{
		public Qskyd_fjrb_temp()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Qskyd_fjrb_temp"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Qskyd_fjrb_temp");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(jdgl_res_head_service.Model.Qskyd_fjrb_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Qskyd_fjrb_temp(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(jdgl_res_head_service.Model.Qskyd_fjrb_temp model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Qskyd_fjrb_temp set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Qskyd_fjrb_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public jdgl_res_head_service.Model.Qskyd_fjrb_temp GetModel(int id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,yydh,qymc,lsbh,krxm,sktt,yddj,fjrb,fjbh,ddsj,lksj,lzfs,shqh,fjjg,sjfjjg,yh,yhbl,bz,is_top,is_select,shsc,czy,czsj,cznr,sdcz,fjbm,jcje from Qskyd_fjrb_temp ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
};
			...
			jdgl_res_head_service.Model.Qskyd_fjrb_temp model=new jdgl_res_head_service.Model.Qskyd_fjrb_temp();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,yydh,qymc,lsbh,krxm,sktt,yddj,fjrb,fjbh,ddsj,lksj,lzfs,shqh,fjjg,sjfjjg,yh,yhbl,bz,is_top,is_select,shsc,czy,czsj,cznr,sdcz,fjbm,jcje ");
			strSql.Append(" FROM Qskyd_fjrb_temp ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,yydh,qymc,lsbh,krxm,sktt,yddj,fjrb,fjbh,ddsj,lksj,lzfs,shqh,fjjg,sjfjjg,yh,yhbl,bz,is_top,is_select,shsc,czy,czsj,cznr,sdcz,fjbm,jcje ");
			strSql.Append(" FROM Qskyd_fjrb_temp ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Qskyd_fjrb_temp T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Qskyd_fjrb_temp";
