...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Ffjrb dal=new jdgl_res_head_service.DAL.Ffjrb();
		public Ffjrb()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Ffjrb GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_service.Model.Ffjrb)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Ffjrb> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Ffjrb> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Ffjrb> modelList = new List<jdgl_res_head_service.Model.Ffjrb>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Ffjrb model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Ffjrb();
