...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Fwx_other_temp dal=new jdgl_res_head_service.DAL.Fwx_other_temp();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Fwx_other_temp GetModelByCache(int id)
		{
			
			string CacheKey = "Fwx_other_tempModel-" + id;
			...
			return (jdgl_res_head_service.Model.Fwx_other_temp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Fwx_other_temp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Fwx_other_temp> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Fwx_other_temp> modelList = new List<jdgl_res_head_service.Model.Fwx_other_temp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Fwx_other_temp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Fwx_other_temp();
