...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Web_Qskyd_fjrb dal=new jdgl_res_head_service.DAL.Web_Qskyd_fjrb();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Web_Qskyd_fjrb GetModelByCache(int id)
		{
			
			string CacheKey = "Web_Qskyd_fjrbModel-" + id;
			...
			return (jdgl_res_head_service.Model.Web_Qskyd_fjrb)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Web_Qskyd_fjrb> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Web_Qskyd_fjrb> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Web_Qskyd_fjrb> modelList = new List<jdgl_res_head_service.Model.Web_Qskyd_fjrb>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Web_Qskyd_fjrb model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Web_Qskyd_fjrb();
