...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Hhyjf_xfjl dal=new jdgl_res_head_service.DAL.Hhyjf_xfjl();
		public Hhyjf_xfjl()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Hhyjf_xfjl GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_service.Model.Hhyjf_xfjl)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Hhyjf_xfjl> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Hhyjf_xfjl> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Hhyjf_xfjl> modelList = new List<jdgl_res_head_service.Model.Hhyjf_xfjl>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Hhyjf_xfjl model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Hhyjf_xfjl();
