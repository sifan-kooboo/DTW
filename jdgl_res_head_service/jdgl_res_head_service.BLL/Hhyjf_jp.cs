...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Hhyjf_jp dal=new jdgl_res_head_service.DAL.Hhyjf_jp();
		public Hhyjf_jp()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Hhyjf_jp GetModelByCache(int ID)
		{
			...
			return (jdgl_res_head_service.Model.Hhyjf_jp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Hhyjf_jp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Hhyjf_jp> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Hhyjf_jp> modelList = new List<jdgl_res_head_service.Model.Hhyjf_jp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Hhyjf_jp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Hhyjf_jp();
