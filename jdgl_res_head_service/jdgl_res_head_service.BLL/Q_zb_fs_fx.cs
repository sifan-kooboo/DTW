...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Q_zb_fs_fx dal=new jdgl_res_head_service.DAL.Q_zb_fs_fx();
		public Q_zb_fs_fx()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Q_zb_fs_fx GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_service.Model.Q_zb_fs_fx)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Q_zb_fs_fx> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Q_zb_fs_fx> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Q_zb_fs_fx> modelList = new List<jdgl_res_head_service.Model.Q_zb_fs_fx>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Q_zb_fs_fx model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Q_zb_fs_fx();
