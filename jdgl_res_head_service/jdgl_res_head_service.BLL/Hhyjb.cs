...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Hhyjb dal=new jdgl_res_head_service.DAL.Hhyjb();
		public Hhyjb()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Hhyjb GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_service.Model.Hhyjb)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Hhyjb> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Hhyjb> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Hhyjb> modelList = new List<jdgl_res_head_service.Model.Hhyjb>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Hhyjb model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Hhyjb();
