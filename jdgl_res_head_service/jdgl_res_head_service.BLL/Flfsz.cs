...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Flfsz dal=new jdgl_res_head_service.DAL.Flfsz();
		public Flfsz()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Flfsz GetModelByCache(int id)
		{
			...
			return (jdgl_res_head_service.Model.Flfsz)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Flfsz> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Flfsz> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Flfsz> modelList = new List<jdgl_res_head_service.Model.Flfsz>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Flfsz model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Flfsz();
