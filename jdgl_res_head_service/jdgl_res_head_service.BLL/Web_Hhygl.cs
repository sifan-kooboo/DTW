...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Web_Hhygl dal=new jdgl_res_head_service.DAL.Web_Hhygl();
		public Web_Hhygl()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Web_Hhygl GetModelByCache(int id)
		{
			
			string CacheKey = "Web_HhyglModel-" + id;
			...
			return (jdgl_res_head_service.Model.Web_Hhygl)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Web_Hhygl> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Web_Hhygl> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Web_Hhygl> modelList = new List<jdgl_res_head_service.Model.Web_Hhygl>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Web_Hhygl model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Web_Hhygl();
