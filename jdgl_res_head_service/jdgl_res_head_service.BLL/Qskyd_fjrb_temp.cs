...
namespace jdgl_res_head_service.BLL
{
	...
	{
		private readonly jdgl_res_head_service.DAL.Qskyd_fjrb_temp dal=new jdgl_res_head_service.DAL.Qskyd_fjrb_temp();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public jdgl_res_head_service.Model.Qskyd_fjrb_temp GetModelByCache(int id)
		{
			
			string CacheKey = "Qskyd_fjrb_tempModel-" + id;
			...
			return (jdgl_res_head_service.Model.Qskyd_fjrb_temp)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Qskyd_fjrb_temp> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<jdgl_res_head_service.Model.Qskyd_fjrb_temp> DataTableToList(DataTable dt)
		{
			List<jdgl_res_head_service.Model.Qskyd_fjrb_temp> modelList = new List<jdgl_res_head_service.Model.Qskyd_fjrb_temp>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				jdgl_res_head_service.Model.Qskyd_fjrb_temp model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new jdgl_res_head_service.Model.Qskyd_fjrb_temp();
