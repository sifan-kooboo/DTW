...
/***********************************************
        lb1 = new ListBuilder();
        lb2 = new ListBuilder("ul");
        lb2.SetTemplate("<a href=sadfasdf?tid={#id} target=\"_blank\">{#title}</a> <span class='date'>[{#date}]</span>");
        lb2.AddTemplateData("id", "2");
        lb2.AddTemplateData("title", "sd还好啦");
        lb2.AddTemplateData("date", "2007-010-10");
        lb2.EndTemplateData();
        lb1.AddTemplateData("lb2", lb2.ToString());
        lb1.SetTemplate("<a href=\"{#url}\" target=\"_blank\"><strong>{#sortName}</strong></a>\r\n{#lb2}");
        lb1.AddTemplateData("url", "dfsf");
        lb1.AddTemplateData("sortName", "dfs34234f");
        lb1.EndTemplateData();
        Label1.Text = lb1.ToString();
 *****生成******
<dl>
   <dd><a href="dfsf" target="_blank"><strong>dfs34234f</strong></a>
     <ul>
      <li><a href=sadfasdf?tid=2 target="_blank">sd还好啦</a> <span class='date'>[2007-010-10]</span></li>
     </ul>
   </dd>
</dl>
 ************************************************/
