    ...
    public class Qskyd_Ffjrb
    {
        ...
        public string Qskyd_fjrb_upload(DataSet DS_Qskydfjrb, string yydh)
        {
            ...
            if (DS_Qskydfjrb != null && DS_Qskydfjrb.Tables[0].Rows.Count > 0)
            {
                ...
                {
                    insert_s = "insert into " + table_name + " (yydh,qymc,lsbh,krxm,sktt,yddj,fjrb,fjbh,ddsj,lksj,lzfs,shqh,fjjg,sjfjjg,yh,yhbl,bz,is_top,is_select,shsc,czy,czsj,cznr,sdcz,fjbm,zcjg,zcjg_je,jydw,yjje,yj_type,is_oper_yj) values ";
                    insert_s = insert_s + "('" + dr["yydh"].ToString() + "','" + dr["qymc"].ToString() + "','" + dr["lsbh"].ToString() + "','" + dr["krxm"].ToString() + "','" + dr["sktt"].ToString() + "','" + dr["yddj"].ToString() + "','" + dr["fjrb"].ToString() + "','" + dr["fjbh"].ToString() + "','" + dr["ddsj"].ToString() + "','" + dr["lksj"].ToString() + "','" + dr["lzfs"].ToString() + "','" + dr["shqh"].ToString() + "','" + dr["fjjg"].ToString() + "','" + dr["sjfjjg"].ToString() + "','" + dr["yh"].ToString() + "','" + dr["yhbl"].ToString() + "','" + dr["bz"].ToString() + "',1,1,1,'" + dr["czy"].ToString() + "','" + dr["czsj"].ToString() + "','" + dr["cznr"].ToString() + "',1,'" + dr["fjbm"].ToString() + "','" + dr["zcjg"].ToString() + "','" + dr["zcjg_je"].ToString() + "'" + dr["jydw"].ToString() + "'" + dr["yjje"].ToString() +"'"+ dr["yj_type"].ToString()+"'"+"'"+dr["is_oper_yj"].ToString()+"')";
                    DbHelperSQL.ExecuteSql(insert_s);
                }
                string strSql = "select * from " + table_name + "";
