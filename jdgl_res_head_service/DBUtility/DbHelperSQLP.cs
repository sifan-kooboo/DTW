...
namespace Maticsoft.DBUtility
{
    ...
    public class DbHelperSQLP
    {
        ...
        public int RunProcedureByDefine(string storedProcName, IDataParameter[] parameters)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                int result;
                connection.Open();
                SqlCommand command = BuildIntCommand_1(connection, storedProcName, parameters);
                //rowsAffected = command.ExecuteNonQuery();
        ...
        private static SqlCommand BuildIntCommand_1(SqlConnection connection, string storedProcName, IDataParameter[] parameters)
        {
            SqlCommand command = BuildQueryCommand(connection, storedProcName, parameters);
            command.Parameters.Add(new SqlParameter("@rows",
                SqlDbType.Int, 4, ParameterDirection.ReturnValue,
                false, 0, 0, string.Empty, DataRowVersion.Default, null));
            return command;
        }
